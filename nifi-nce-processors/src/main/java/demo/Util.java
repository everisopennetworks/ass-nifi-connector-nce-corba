               ...
               switch (any.type().kind().value()) {
                ...
                case TCKind._tk_struct:
                {
                    ...
                    for (int i = 0; i < members.length; i++) {
                        ...
                        result.append("\"").append(parseAny(members[i].value)).append("\"");
                    }
                    result.append(",");
                    break;
                }
                ...
                case TCKind._tk_array:
                   ...
                   case TCKind._tk_alias:
                       DynSequence dyn_alias = (DynSequence) factory.create_dyn_any(any);
                       Any[] array_contents_a = dyn_alias.get_elements();
                       result.append("{");
                       for (int i = 0; i < array_contents_a.length; i++){
                           result.append(parseAny(array_contents_a[i]) );
                       }
