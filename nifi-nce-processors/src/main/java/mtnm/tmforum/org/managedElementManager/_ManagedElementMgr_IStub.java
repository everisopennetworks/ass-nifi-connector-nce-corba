...
public class _ManagedElementMgr_IStub
	...
	implements mtnm.tmforum.org.managedElementManager.ManagedElementMgr_I
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = mtnm.tmforum.org.managedElementManager.ManagedElementMgr_IOperations.class;
	...
	public void getAvailableTimeSlot(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] tpName, org.omg.CORBA.StringHolder timeslot) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getAvailableTimeSlot", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,tpName);
					_is = _invoke(_os);
					timeslot.value = _is.read_string();
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "getAvailableTimeSlot", _opsClass );
			if( _so == null )
				continue;
			ManagedElementMgr_IOperations _localServant = (ManagedElementMgr_IOperations)_so.servant;
			try
			{
				_localServant.getAvailableTimeSlot(tpName,timeslot);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mtnm.tmforum.org.subnetworkConnection.CrossConnectList_THelper.write(_os,ccList);
					_is = _invoke(_os);
					successedCCList.value = mtnm.tmforum.org.subnetworkConnection.CrossConnectList_THelper.read(_is);
					failedCCList.value = mtnm.tmforum.org.subnetworkConnection.CrossConnectList_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
	...
	public void checkActiveAlarms(org.omg.CosNotification.StructuredEvent[] activeEventList, mtnm.tmforum.org.notifications.EventList_THolder clearedEventList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "checkActiveAlarms", true);
					mtnm.tmforum.org.notifications.EventList_THelper.write(_os,activeEventList);
					_is = _invoke(_os);
					clearedEventList.value = mtnm.tmforum.org.notifications.EventList_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
	...
	public void modifyFTPMembers(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] ftpName, java.lang.String modifyType, mtnm.tmforum.org.subnetworkConnection.TPData_T[] tpList, mtnm.tmforum.org.subnetworkConnection.TPDataList_THolder successedTPList, mtnm.tmforum.org.subnetworkConnection.TPDataList_THolder failedTPList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "modifyFTPMembers", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,ftpName);
					java.lang.String tmpResult496 = modifyType;
_os.write_string( tmpResult496 );
					mtnm.tmforum.org.subnetworkConnection.TPDataList_THelper.write(_os,tpList);
					_is = _invoke(_os);
					successedTPList.value = mtnm.tmforum.org.subnetworkConnection.TPDataList_THelper.read(_is);
					failedTPList.value = mtnm.tmforum.org.subnetworkConnection.TPDataList_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
	...
	public void setAPRInfo(mtnm.tmforum.org.managedElementManager.ManagedElementMgr_IPackage.CommonObjSturct_T aprInfo, mtnm.tmforum.org.managedElementManager.ManagedElementMgr_IPackage.CommonObjSturct_THolder modifiedaprInfo) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "setAPRInfo", true);
					mtnm.tmforum.org.managedElementManager.ManagedElementMgr_IPackage.CommonObjSturct_THelper.write(_os,aprInfo);
					_is = _invoke(_os);
					modifiedaprInfo.value = mtnm.tmforum.org.managedElementManager.ManagedElementMgr_IPackage.CommonObjSturct_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult497 = owner;
_os.write_string( tmpResult497 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
	...
	public void getContainingTPNames(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] tpName, mtnm.tmforum.org.globaldefs.NamingAttributesList_THolder tpNameList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getContainingTPNames", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,tpName);
					_is = _invoke(_os);
					tpNameList.value = mtnm.tmforum.org.globaldefs.NamingAttributesList_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
	...
	public void setAPEInfo(mtnm.tmforum.org.managedElementManager.ManagedElementMgr_IPackage.CommonObjSturct_T apeInfo) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "setAPEInfo", true);
					mtnm.tmforum.org.managedElementManager.ManagedElementMgr_IPackage.CommonObjSturct_THelper.write(_os,apeInfo);
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
	...
	public void getAllAlarmsByFTP(java.lang.String destination, java.lang.String userName, java.lang.String password, mtnm.tmforum.org.globaldefs.NameAndStringValue_T[][] meNameList, java.lang.String[] excludeProbCauseList, mtnm.tmforum.org.notifications.PerceivedSeverity_T[] excludeSeverityList, java.lang.String startTime, java.lang.String endTime, mtnm.tmforum.org.globaldefs.NamingAttributesList_THolder failedMeNameList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getAllAlarmsByFTP", true);
					java.lang.String tmpResult498 = destination;
_os.write_string( tmpResult498 );
					java.lang.String tmpResult499 = userName;
_os.write_string( tmpResult499 );
					java.lang.String tmpResult500 = password;
_os.write_string( tmpResult500 );
					...
					java.lang.String tmpResult501 = startTime;
_os.write_string( tmpResult501 );
					java.lang.String tmpResult502 = endTime;
_os.write_string( tmpResult502 );
					_is = _invoke(_os);
					failedMeNameList.value = mtnm.tmforum.org.globaldefs.NamingAttributesList_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
	...
	public void getADCInfo(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] objName, mtnm.tmforum.org.managedElementManager.ManagedElementMgr_IPackage.CommonObjSturctList_THolder adcInfoLst) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getADCInfo", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,objName);
					_is = _invoke(_os);
					adcInfoLst.value = mtnm.tmforum.org.managedElementManager.ManagedElementMgr_IPackage.CommonObjSturctList_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
	...
	public void modifyCrossConnection(mtnm.tmforum.org.subnetworkConnection.CrossConnect_T ccToModify, mtnm.tmforum.org.subnetworkConnection.CrossConnect_T newCc, mtnm.tmforum.org.subnetworkConnection.CrossConnect_THolder modifiedCc) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "modifyCrossConnection", true);
					mtnm.tmforum.org.subnetworkConnection.CrossConnect_THelper.write(_os,ccToModify);
					mtnm.tmforum.org.subnetworkConnection.CrossConnect_THelper.write(_os,newCc);
					_is = _invoke(_os);
					modifiedCc.value = mtnm.tmforum.org.subnetworkConnection.CrossConnect_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
	...
	public void getAllPTPNames(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] managedElementName, short[] tpLayerRateList, short[] connectionLayerRateList, int how_many, mtnm.tmforum.org.globaldefs.NamingAttributesList_THolder nameList, mtnm.tmforum.org.globaldefs.NamingAttributesIterator_IHolder nameIt) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getAllPTPNames", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,managedElementName);
					mtnm.tmforum.org.transmissionParameters.LayerRateList_THelper.write(_os,tpLayerRateList);
					mtnm.tmforum.org.transmissionParameters.LayerRateList_THelper.write(_os,connectionLayerRateList);
					_os.write_ulong(how_many);
	...
	public void getNEStaticInfo(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] managedElementName, int how_many, mtnm.tmforum.org.globaldefs.NamingAttributesList_THolder staticInfoList, mtnm.tmforum.org.globaldefs.NamingAttributesIterator_IHolder staticInfoIt) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getNEStaticInfo", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,managedElementName);
					_os.write_ulong(how_many);
					_is = _invoke(_os);
					staticInfoList.value = mtnm.tmforum.org.globaldefs.NamingAttributesList_THelper.read(_is);
					staticInfoIt.value = mtnm.tmforum.org.globaldefs.NamingAttributesIterator_IHelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
	...
	public void setotnALCInfo(mtnm.tmforum.org.managedElementManager.ManagedElementMgr_IPackage.CommonObjSturct_T otnalcInfo) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "setotnALCInfo", true);
					mtnm.tmforum.org.managedElementManager.ManagedElementMgr_IPackage.CommonObjSturct_THelper.write(_os,otnalcInfo);
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
	...
	public void getActiveAlarms(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[][] objectNameList, java.lang.String[] excludeProbCauseList, mtnm.tmforum.org.notifications.PerceivedSeverity_T[] excludeSeverityList, int how_many, mtnm.tmforum.org.notifications.EventList_THolder eventList, mtnm.tmforum.org.notifications.EventIterator_IHolder eventIt) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getActiveAlarms", true);
					mtnm.tmforum.org.globaldefs.NamingAttributesList_THelper.write(_os,objectNameList);
					mtnm.tmforum.org.notifications.ProbableCauseList_THelper.write(_os,excludeProbCauseList);
					mtnm.tmforum.org.notifications.PerceivedSeverityList_THelper.write(_os,excludeSeverityList);
					_os.write_ulong(how_many);
					_is = _invoke(_os);
	...
	public void setwdmALCInfo(mtnm.tmforum.org.managedElementManager.ManagedElementMgr_IPackage.CommonObjSturct_T wdmalcInfo) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "setwdmALCInfo", true);
					mtnm.tmforum.org.managedElementManager.ManagedElementMgr_IPackage.CommonObjSturct_THelper.write(_os,wdmalcInfo);
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
	...
	public void getAllManagedElementGroups(int how_many, mtnm.tmforum.org.managedElement.neGroupInfoList_THolder neGroupInfoList, mtnm.tmforum.org.managedElement.neGroupInfoListIterator_IHolder neGroupInfoIt) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getAllManagedElementGroups", true);
					_os.write_ulong(how_many);
					_is = _invoke(_os);
					neGroupInfoList.value = mtnm.tmforum.org.managedElement.neGroupInfoList_THelper.read(_is);
					neGroupInfoIt.value = mtnm.tmforum.org.managedElement.neGroupInfoListIterator_IHelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "getAllManagedElementGroups", _opsClass );
			if( _so == null )
				continue;
			ManagedElementMgr_IOperations _localServant = (ManagedElementMgr_IOperations)_so.servant;
			try
			{
				_localServant.getAllManagedElementGroups(how_many,neGroupInfoList,neGroupInfoIt);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					ccIt.value = mtnm.tmforum.org.subnetworkConnection.CCIterator_IHelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
	...
	public void getContainingSubnetworkNames(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] managedElementName, mtnm.tmforum.org.globaldefs.NamingAttributesList_THolder subnetNames) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getContainingSubnetworkNames", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,managedElementName);
					_is = _invoke(_os);
					subnetNames.value = mtnm.tmforum.org.globaldefs.NamingAttributesList_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
	...
	public void getFTPMembers(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] ftpName, mtnm.tmforum.org.subnetworkConnection.TPDataList_THolder tpList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getFTPMembers", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,ftpName);
					_is = _invoke(_os);
					tpList.value = mtnm.tmforum.org.subnetworkConnection.TPDataList_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
	...
	public void getContainingTPs(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] tpName, mtnm.tmforum.org.terminationPoint.TerminationPointList_THolder tpList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getContainingTPs", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,tpName);
					_is = _invoke(_os);
					tpList.value = mtnm.tmforum.org.terminationPoint.TerminationPointList_THelper.read(_is);
					return;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,tpName);
					_is = _invoke(_os);
					tp.value = mtnm.tmforum.org.terminationPoint.TerminationPoint_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,objectName);
					java.lang.String tmpResult503 = userLabel;
_os.write_string( tmpResult503 );
	...
	public void getAPRInfo(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] objName, mtnm.tmforum.org.managedElementManager.ManagedElementMgr_IPackage.CommonObjSturctList_THolder aprInfoLst) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getAPRInfo", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,objName);
					_is = _invoke(_os);
					aprInfoLst.value = mtnm.tmforum.org.managedElementManager.ManagedElementMgr_IPackage.CommonObjSturctList_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,managedElementName);
					_is = _invoke(_os);
					me.value = mtnm.tmforum.org.managedElement.ManagedElement_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
	...
	public void setADCInfo(mtnm.tmforum.org.managedElementManager.ManagedElementMgr_IPackage.CommonObjSturct_T adcInfo, mtnm.tmforum.org.managedElementManager.ManagedElementMgr_IPackage.CommonObjSturct_THolder modifiedadcInfo) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "setADCInfo", true);
					mtnm.tmforum.org.managedElementManager.ManagedElementMgr_IPackage.CommonObjSturct_THelper.write(_os,adcInfo);
					_is = _invoke(_os);
					modifiedadcInfo.value = mtnm.tmforum.org.managedElementManager.ManagedElementMgr_IPackage.CommonObjSturct_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
	...
	public void getAllManagedElementsWithMEGroup(java.lang.String[] neGroupNameList, mtnm.tmforum.org.managedElement.neGroupList_THolder neGroupList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getAllManagedElementsWithMEGroup", true);
					mtnm.tmforum.org.managedElement.neGroupNameList_THelper.write(_os,neGroupNameList);
					_is = _invoke(_os);
					neGroupList.value = mtnm.tmforum.org.managedElement.neGroupList_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "getAllManagedElementsWithMEGroup", _opsClass );
			if( _so == null )
				continue;
			ManagedElementMgr_IOperations _localServant = (ManagedElementMgr_IOperations)_so.servant;
			try
			{
				_localServant.getAllManagedElementsWithMEGroup(neGroupNameList,neGroupList);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mtnm.tmforum.org.subnetworkConnection.TPData_THelper.write(_os,tpInfo);
					_is = _invoke(_os);
					modifiedTP.value = mtnm.tmforum.org.terminationPoint.TerminationPoint_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
	...
	public void getAllLLDPs(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] name, mtnm.tmforum.org.managedElement.PortLLDPList_THolder portLLDPList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getAllLLDPs", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,name);
					_is = _invoke(_os);
					portLLDPList.value = mtnm.tmforum.org.managedElement.PortLLDPList_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "getAllLLDPs", _opsClass );
			if( _so == null )
				continue;
			ManagedElementMgr_IOperations _localServant = (ManagedElementMgr_IOperations)_so.servant;
			try
			{
				_localServant.getAllLLDPs(name,portLLDPList);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,objectName);
					java.lang.String tmpResult504 = nativeEMSName;
_os.write_string( tmpResult504 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
