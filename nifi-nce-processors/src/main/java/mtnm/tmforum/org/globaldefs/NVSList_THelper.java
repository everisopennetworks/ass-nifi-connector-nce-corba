...
public abstract class NVSList_THelper
{
	...
	public static mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		{
			 int x = _in.available();
			 if ( x > 0 && _l_result51 > x )
				{
					throw new org.omg.CORBA.MARSHAL("Sequence length too large. Only " + x + " available and trying to assign " + _l_result51);
				}
		}
		catch (java.io.IOException e)
		{
		}
		_result = new mtnm.tmforum.org.globaldefs.NameAndStringValue_T[_l_result51];
