...
public abstract class NamingAttributesMultipleList_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(NamingAttributesMultipleList_THelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_alias_tc(mtnm.tmforum.org.globaldefs.NamingAttributesMultipleList_THelper.id(), "NamingAttributesMultipleList_T",org.omg.CORBA.ORB.init().create_sequence_tc(0, mtnm.tmforum.org.globaldefs.NamingAttributesList_THelper.type()));
				}
			}
		}
		return _type;
	...
	public static mtnm.tmforum.org.globaldefs.NameAndStringValue_T[][][] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new mtnm.tmforum.org.globaldefs.NameAndStringValue_T[_l_result53][][];
		for (int i=0;i<_result.length;i++)
		{
			_result[i] = mtnm.tmforum.org.globaldefs.NamingAttributesList_THelper.read(_in);
		}
	...
	public static void write (final org.omg.CORBA.portable.OutputStream _out, mtnm.tmforum.org.globaldefs.NameAndStringValue_T[][][] _s)
	{
		...
		{
			mtnm.tmforum.org.globaldefs.NamingAttributesList_THelper.write(_out,_s[i]);
		}
