...
public class _MaintenanceMgr_IStub
	...
	implements mtnm.tmforum.org.maintenanceOps.MaintenanceMgr_I
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = mtnm.tmforum.org.maintenanceOps.MaintenanceMgr_IOperations.class;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult477 = nativeEMSName;
_os.write_string( tmpResult477 );
					_is = _invoke(_os);
					return;
				}
	...
	public void performMaintenanceOperationEx(mtnm.tmforum.org.maintenanceOps.CurrentMaintenanceOperation_T maintenanceOperation, mtnm.tmforum.org.maintenanceOps.MaintenanceOperationMode_T maintenanceOperationMode, mtnm.tmforum.org.globaldefs.NamingAttributesList_THolder resultOfMaintenanceData) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "performMaintenanceOperationEx", true);
					mtnm.tmforum.org.maintenanceOps.CurrentMaintenanceOperation_THelper.write(_os,maintenanceOperation);
					mtnm.tmforum.org.maintenanceOps.MaintenanceOperationMode_THelper.write(_os,maintenanceOperationMode);
					_is = _invoke(_os);
					resultOfMaintenanceData.value = mtnm.tmforum.org.globaldefs.NamingAttributesList_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
	...
	public void getActiveMaintenanceOperations(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] tpOrMeName, int how_many, mtnm.tmforum.org.maintenanceOps.CurrentMaintenanceOperationList_THolder currentMaintenanceOpeationList, mtnm.tmforum.org.maintenanceOps.CurrentMaintenanceOperationIterator_IHolder cmoIt) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getActiveMaintenanceOperations", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,tpOrMeName);
					_os.write_ulong(how_many);
					_is = _invoke(_os);
					currentMaintenanceOpeationList.value = mtnm.tmforum.org.maintenanceOps.CurrentMaintenanceOperationList_THelper.read(_is);
					cmoIt.value = mtnm.tmforum.org.maintenanceOps.CurrentMaintenanceOperationIterator_IHelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
	...
	public void setOAMParameters(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] name, java.lang.String oamParamType, mtnm.tmforum.org.transmissionParameters.LayeredParameters_T[] ParamList, mtnm.tmforum.org.maintenanceOps.MaintenanceMgr_IPackage.OAMParametersData_THolder oamParameters) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "setOAMParameters", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,name);
					java.lang.String tmpResult478 = oamParamType;
_os.write_string( tmpResult478 );
					mtnm.tmforum.org.transmissionParameters.LayeredParameterList_THelper.write(_os,ParamList);
					_is = _invoke(_os);
					oamParameters.value = mtnm.tmforum.org.maintenanceOps.MaintenanceMgr_IPackage.OAMParametersData_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
	...
	public void getOAMParameters(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] name, mtnm.tmforum.org.transmissionParameters.LayeredParameterList_THolder ParamList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getOAMParameters", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,name);
					_is = _invoke(_os);
					ParamList.value = mtnm.tmforum.org.transmissionParameters.LayeredParameterList_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
	...
	public void performMaintenanceOperation(mtnm.tmforum.org.maintenanceOps.CurrentMaintenanceOperation_T maintenanceOperation, mtnm.tmforum.org.maintenanceOps.MaintenanceOperationMode_T maintenanceOperationMode) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "performMaintenanceOperation", true);
					mtnm.tmforum.org.maintenanceOps.CurrentMaintenanceOperation_THelper.write(_os,maintenanceOperation);
					mtnm.tmforum.org.maintenanceOps.MaintenanceOperationMode_THelper.write(_os,maintenanceOperationMode);
					_is = _invoke(_os);
					return;
	...
	public void disablePRBSTest(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[][] tpNameList, mtnm.tmforum.org.globaldefs.NamingAttributesList_THolder failedTPList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "disablePRBSTest", true);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,objectName);
					java.lang.String tmpResult479 = userLabel;
_os.write_string( tmpResult479 );
	...
	public void setServiceAlarmReportingOn(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] serviceName, java.lang.String[] alarmEventList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "setServiceAlarmReportingOn", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,serviceName);
					mtnm.tmforum.org.maintenanceOps.AlarmEventList_THelper.write(_os,alarmEventList);
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
	...
	public void getPRBSTestResult(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[][] tpNameList, mtnm.tmforum.org.maintenanceOps.PRBSTestResultList_THolder resultList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getPRBSTestResult", true);
					mtnm.tmforum.org.globaldefs.NamingAttributesList_THelper.write(_os,tpNameList);
					_is = _invoke(_os);
					resultList.value = mtnm.tmforum.org.maintenanceOps.PRBSTestResultList_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
	...
	public void createATMMaintenanceEntity(mtnm.tmforum.org.maintenanceOps.HW_ATMMaintenanceEntityAttr_T maintenanceEntityAttr, mtnm.tmforum.org.globaldefs.NVSList_THolder maintenanceEntityName) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "createATMMaintenanceEntity", true);
					mtnm.tmforum.org.maintenanceOps.HW_ATMMaintenanceEntityAttr_THelper.write(_os,maintenanceEntityAttr);
					_is = _invoke(_os);
					maintenanceEntityName.value = mtnm.tmforum.org.globaldefs.NVSList_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
	...
	public void deleteMaintenanceAssociation(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] maName) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "deleteMaintenanceAssociation", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,maName);
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
	...
	public void setServiceAlarmReportingOff(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] serviceName, java.lang.String[] alarmEventList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "setServiceAlarmReportingOff", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,serviceName);
					mtnm.tmforum.org.maintenanceOps.AlarmEventList_THelper.write(_os,alarmEventList);
					_is = _invoke(_os);
					return;
	...
	public void createMaintenanceDomain(mtnm.tmforum.org.maintenanceOps.HW_MaintenanceDomain_T md, mtnm.tmforum.org.maintenanceOps.HW_MaintenanceDomain_THolder theMD, org.omg.CORBA.StringHolder errorReason) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "createMaintenanceDomain", true);
					mtnm.tmforum.org.maintenanceOps.HW_MaintenanceDomain_THelper.write(_os,md);
					_is = _invoke(_os);
					theMD.value = mtnm.tmforum.org.maintenanceOps.HW_MaintenanceDomain_THelper.read(_is);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,objectName);
					java.lang.String tmpResult480 = owner;
_os.write_string( tmpResult480 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
	...
	public void getAllMaintenanceAssociations(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] mdName, int how_many, mtnm.tmforum.org.maintenanceOps.HW_MaintenanceAssociationList_THolder maList, mtnm.tmforum.org.maintenanceOps.HW_MaintenanceAssociationIterator_IHolder maIt) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getAllMaintenanceAssociations", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,mdName);
					_os.write_ulong(how_many);
					_is = _invoke(_os);
					maList.value = mtnm.tmforum.org.maintenanceOps.HW_MaintenanceAssociationList_THelper.read(_is);
					maIt.value = mtnm.tmforum.org.maintenanceOps.HW_MaintenanceAssociationIterator_IHelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
	...
	public void createMaintenancePoints(mtnm.tmforum.org.maintenanceOps.HW_MaintenancePointCreateData_T mpCreateData, mtnm.tmforum.org.maintenanceOps.HW_MaintenancePoint_THolder theMP, org.omg.CORBA.StringHolder errorReason) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "createMaintenancePoints", true);
					mtnm.tmforum.org.maintenanceOps.HW_MaintenancePointCreateData_THelper.write(_os,mpCreateData);
					_is = _invoke(_os);
					theMP.value = mtnm.tmforum.org.maintenanceOps.HW_MaintenancePoint_THelper.read(_is);
					errorReason.value = _is.read_string();
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
	...
	public void createMaintenanceAssociation(mtnm.tmforum.org.maintenanceOps.HW_MaintenanceAssociation_T ma, mtnm.tmforum.org.maintenanceOps.HW_MaintenanceAssociation_THolder theMA, org.omg.CORBA.StringHolder errorReason) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "createMaintenanceAssociation", true);
					mtnm.tmforum.org.maintenanceOps.HW_MaintenanceAssociation_THelper.write(_os,ma);
					_is = _invoke(_os);
					theMA.value = mtnm.tmforum.org.maintenanceOps.HW_MaintenanceAssociation_THelper.read(_is);
					errorReason.value = _is.read_string();
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
	...
	public void deleteMaintenancePoint(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] mpName) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "deleteMaintenancePoint", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,mpName);
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
	...
	public void getAllMaintenanceDomains(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] meName, int how_many, mtnm.tmforum.org.maintenanceOps.HW_MaintenanceDomainList_THolder mdList, mtnm.tmforum.org.maintenanceOps.HW_MaintenanceDomainIterator_IHolder mdIt) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getAllMaintenanceDomains", true);
					...
					mdIt.value = mtnm.tmforum.org.maintenanceOps.HW_MaintenanceDomainIterator_IHelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
	...
	public void getAllMaintenancePoints(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] mdOrMaName, int how_many, mtnm.tmforum.org.maintenanceOps.HW_MaintenancePointList_THolder mpList, mtnm.tmforum.org.maintenanceOps.HW_MaintenancePointIterator_IHolder mpIt) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getAllMaintenancePoints", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,mdOrMaName);
					_os.write_ulong(how_many);
					_is = _invoke(_os);
					mpList.value = mtnm.tmforum.org.maintenanceOps.HW_MaintenancePointList_THelper.read(_is);
					mpIt.value = mtnm.tmforum.org.maintenanceOps.HW_MaintenancePointIterator_IHelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
	...
	public void enablePRBSTest(mtnm.tmforum.org.maintenanceOps.PRBSTestParameter_T[] testParaList, mtnm.tmforum.org.globaldefs.NamingAttributesList_THolder failedTPList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "enablePRBSTest", true);
					mtnm.tmforum.org.maintenanceOps.PRBSTestParameterList_THelper.write(_os,testParaList);
					_is = _invoke(_os);
					failedTPList.value = mtnm.tmforum.org.globaldefs.NamingAttributesList_THelper.read(_is);
					return;
				}
	...
	public void deleteMaintenanceDomain(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] mdName) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "deleteMaintenanceDomain", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,mdName);
					_is = _invoke(_os);
					return;
				}
