...
public interface HW_MaintenancePointIterator_IOperations
{
	/* constants */
	/* operations  */
	boolean next_n(int how_many, mtnm.tmforum.org.maintenanceOps.HW_MaintenancePointList_THolder mpList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException;
