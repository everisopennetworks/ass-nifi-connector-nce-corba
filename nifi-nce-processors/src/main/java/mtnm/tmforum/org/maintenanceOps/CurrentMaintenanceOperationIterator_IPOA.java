...
public abstract class CurrentMaintenanceOperationIterator_IPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, mtnm.tmforum.org.maintenanceOps.CurrentMaintenanceOperationIterator_IOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				mtnm.tmforum.org.maintenanceOps.CurrentMaintenanceOperationList_THolder _arg1= new mtnm.tmforum.org.maintenanceOps.CurrentMaintenanceOperationList_THolder();
				_out = handler.createReply();
				_out.write_boolean(next_n(_arg0,_arg1));
				mtnm.tmforum.org.maintenanceOps.CurrentMaintenanceOperationList_THelper.write(_out,_arg1.value);
			}
			catch(mtnm.tmforum.org.globaldefs.ProcessingFailureException _ex0)
			{
				_out = handler.createExceptionReply();
