...
public interface HW_MaintenanceDomainIterator_IOperations
{
	/* constants */
	/* operations  */
	boolean next_n(int how_many, mtnm.tmforum.org.maintenanceOps.HW_MaintenanceDomainList_THolder mdList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException;
