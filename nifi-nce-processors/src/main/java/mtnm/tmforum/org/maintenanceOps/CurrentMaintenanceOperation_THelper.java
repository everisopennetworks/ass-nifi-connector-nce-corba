...
public abstract class CurrentMaintenanceOperation_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(CurrentMaintenanceOperation_THelper.class)
			{
				if (_type == null)
				{
	...
	public static void insert (final org.omg.CORBA.Any any, final mtnm.tmforum.org.maintenanceOps.CurrentMaintenanceOperation_T s)
	{
		any.type(type());
	...
	public static mtnm.tmforum.org.maintenanceOps.CurrentMaintenanceOperation_T read (final org.omg.CORBA.portable.InputStream in)
	{
		mtnm.tmforum.org.maintenanceOps.CurrentMaintenanceOperation_T result = new mtnm.tmforum.org.maintenanceOps.CurrentMaintenanceOperation_T();
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final mtnm.tmforum.org.maintenanceOps.CurrentMaintenanceOperation_T s)
	{
		mtnm.tmforum.org.globaldefs.NVSList_THelper.write(out,s.tpName);
		java.lang.String tmpResult448 = s.maintenanceOperation;
out.write_string( tmpResult448 );
