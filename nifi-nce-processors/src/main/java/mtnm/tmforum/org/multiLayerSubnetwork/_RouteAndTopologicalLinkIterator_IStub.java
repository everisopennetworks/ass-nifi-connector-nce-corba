...
public class _RouteAndTopologicalLinkIterator_IStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements mtnm.tmforum.org.multiLayerSubnetwork.RouteAndTopologicalLinkIterator_I
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = mtnm.tmforum.org.multiLayerSubnetwork.RouteAndTopologicalLinkIterator_IOperations.class;
	public int getLength() throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			RouteAndTopologicalLinkIterator_IOperations _localServant = (RouteAndTopologicalLinkIterator_IOperations)_so.servant;
			int _result;
			try
			{
	...
	public boolean next_n(int how_many, mtnm.tmforum.org.multiLayerSubnetwork.RouteAndTopologicalLinkList_THolder routeAndTlList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					routeAndTlList.value = mtnm.tmforum.org.multiLayerSubnetwork.RouteAndTopologicalLinkList_THelper.read(_is);
					return _result;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
		...
		else
		{
			...
			try
			{
				_result = _localServant.next_n(how_many,routeAndTlList);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
