...
public interface CCIterator_IOperations
{
	/* constants */
	/* operations  */
	boolean next_n(int how_many, mtnm.tmforum.org.subnetworkConnection.CrossConnectList_THolder ccList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException;
