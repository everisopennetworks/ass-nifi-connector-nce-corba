...
public abstract class TPData_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(TPData_THelper.class)
			{
				if (_type == null)
				{
	...
	public static void insert (final org.omg.CORBA.Any any, final mtnm.tmforum.org.subnetworkConnection.TPData_T s)
	{
		any.type(type());
	...
	public static mtnm.tmforum.org.subnetworkConnection.TPData_T read (final org.omg.CORBA.portable.InputStream in)
	{
		mtnm.tmforum.org.subnetworkConnection.TPData_T result = new mtnm.tmforum.org.subnetworkConnection.TPData_T();
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final mtnm.tmforum.org.subnetworkConnection.TPData_T s)
	{
