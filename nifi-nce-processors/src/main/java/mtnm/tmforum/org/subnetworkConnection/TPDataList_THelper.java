...
public abstract class TPDataList_THelper
{
	private volatile static org.omg.CORBA.TypeCode _type;

	public static void insert (org.omg.CORBA.Any any, mtnm.tmforum.org.subnetworkConnection.TPData_T[] s)
	{
		any.type (type ());
		write (any.create_output_stream (), s);
	}

	public static mtnm.tmforum.org.subnetworkConnection.TPData_T[] extract (final org.omg.CORBA.Any any)
	{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(TPDataList_THelper.class)
			{
				if (_type == null)
				{
	...
	public static mtnm.tmforum.org.subnetworkConnection.TPData_T[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		mtnm.tmforum.org.subnetworkConnection.TPData_T[] _result;
		...
		_result = new mtnm.tmforum.org.subnetworkConnection.TPData_T[_l_result168];
		for (int i=0;i<_result.length;i++)
		{
			_result[i]=mtnm.tmforum.org.subnetworkConnection.TPData_THelper.read(_in);
		}

		return _result;
	}

	public static void write (final org.omg.CORBA.portable.OutputStream _out, mtnm.tmforum.org.subnetworkConnection.TPData_T[] _s)
	{
		
		_out.write_long(_s.length);
		for (int i=0; i<_s.length;i++)
		{
			mtnm.tmforum.org.subnetworkConnection.TPData_THelper.write(_out,_s[i]);
		}
