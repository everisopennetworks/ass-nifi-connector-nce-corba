...
public abstract class SubnetworkConnection_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(SubnetworkConnection_THelper.class)
			{
				if (_type == null)
				{
	...
	public static void insert (final org.omg.CORBA.Any any, final mtnm.tmforum.org.subnetworkConnection.SubnetworkConnection_T s)
	{
		any.type(type());
	...
	public static mtnm.tmforum.org.subnetworkConnection.SubnetworkConnection_T read (final org.omg.CORBA.portable.InputStream in)
	{
		mtnm.tmforum.org.subnetworkConnection.SubnetworkConnection_T result = new mtnm.tmforum.org.subnetworkConnection.SubnetworkConnection_T();
		result.name = mtnm.tmforum.org.globaldefs.NVSList_THelper.read(in);
		result.userLabel=in.read_string();
		result.nativeEMSName=in.read_string();
		result.owner=in.read_string();
		result.sncState=mtnm.tmforum.org.subnetworkConnection.SNCState_THelper.read(in);
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final mtnm.tmforum.org.subnetworkConnection.SubnetworkConnection_T s)
	{
		mtnm.tmforum.org.globaldefs.NVSList_THelper.write(out,s.name);
		java.lang.String tmpResult665 = s.userLabel;
out.write_string( tmpResult665 );
		java.lang.String tmpResult666 = s.nativeEMSName;
out.write_string( tmpResult666 );
		java.lang.String tmpResult667 = s.owner;
out.write_string( tmpResult667 );
		mtnm.tmforum.org.subnetworkConnection.SNCState_THelper.write(out,s.sncState);
