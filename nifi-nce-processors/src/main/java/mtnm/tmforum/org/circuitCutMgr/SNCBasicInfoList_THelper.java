...
/**
 * Generated from IDL alias "SNCBasicInfoList_T".
 *
 * @author JacORB IDL compiler V 3.9
 * @version generated at 13/07/2021 04:51:40 PM
 */

public abstract class SNCBasicInfoList_THelper
{
	private volatile static org.omg.CORBA.TypeCode _type;

	public static void insert (org.omg.CORBA.Any any, mtnm.tmforum.org.circuitCutMgr.SNCBasicInfo_T[] s)
	{
		any.type (type ());
		write (any.create_output_stream (), s);
	}

	public static mtnm.tmforum.org.circuitCutMgr.SNCBasicInfo_T[] extract (final org.omg.CORBA.Any any)
	{
	...
	public static mtnm.tmforum.org.circuitCutMgr.SNCBasicInfo_T[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		mtnm.tmforum.org.circuitCutMgr.SNCBasicInfo_T[] _result;
		...
		_result = new mtnm.tmforum.org.circuitCutMgr.SNCBasicInfo_T[_l_result8];
		for (int i=0;i<_result.length;i++)
		{
			_result[i]=mtnm.tmforum.org.circuitCutMgr.SNCBasicInfo_THelper.read(_in);
		}

		return _result;
	}

	public static void write (final org.omg.CORBA.portable.OutputStream _out, mtnm.tmforum.org.circuitCutMgr.SNCBasicInfo_T[] _s)
	{
		
		_out.write_long(_s.length);
		for (int i=0; i<_s.length;i++)
		{
			mtnm.tmforum.org.circuitCutMgr.SNCBasicInfo_THelper.write(_out,_s[i]);
		}
