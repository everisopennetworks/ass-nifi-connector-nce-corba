...
public abstract class ServiceLimitList_THelper
{
	private volatile static org.omg.CORBA.TypeCode _type;

	public static void insert (org.omg.CORBA.Any any, mtnm.tmforum.org.circuitCutMgr.ServiceLimit_T[] s)
	{
		any.type (type ());
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(ServiceLimitList_THelper.class)
			{
				if (_type == null)
				{
	...
	public static mtnm.tmforum.org.circuitCutMgr.ServiceLimit_T[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		mtnm.tmforum.org.circuitCutMgr.ServiceLimit_T[] _result;
		...
		_result = new mtnm.tmforum.org.circuitCutMgr.ServiceLimit_T[_l_result10];
		for (int i=0;i<_result.length;i++)
		{
			_result[i]=mtnm.tmforum.org.circuitCutMgr.ServiceLimit_THelper.read(_in);
		}

		return _result;
	}

	public static void write (final org.omg.CORBA.portable.OutputStream _out, mtnm.tmforum.org.circuitCutMgr.ServiceLimit_T[] _s)
	{
		
		_out.write_long(_s.length);
		for (int i=0; i<_s.length;i++)
		{
			mtnm.tmforum.org.circuitCutMgr.ServiceLimit_THelper.write(_out,_s[i]);
		}
