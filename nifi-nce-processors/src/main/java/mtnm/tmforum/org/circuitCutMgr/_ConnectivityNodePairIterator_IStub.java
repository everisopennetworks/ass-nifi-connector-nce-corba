...
public class _ConnectivityNodePairIterator_IStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements mtnm.tmforum.org.circuitCutMgr.ConnectivityNodePairIterator_I
{
	/** Serial version UID. */
	private static final long serialVersionUID = 1L;
	private String[] ids = {"IDL:mtnm.tmforum.org/circuitCutMgr/ConnectivityNodePairIterator_I:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = mtnm.tmforum.org.circuitCutMgr.ConnectivityNodePairIterator_IOperations.class;
	public int getLength() throws mtnm.tmforum.org.circuitCutMgr.ProcessingFailureException
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			ConnectivityNodePairIterator_IOperations _localServant = (ConnectivityNodePairIterator_IOperations)_so.servant;
			int _result;
			try
			{
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					meList.value = mtnm.tmforum.org.circuitCutMgr.ConnectivityNodePairList_THelper.read(_is);
					return _result;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
