...
public abstract class NameAndStringValue_THelper
{
	...
	public static void insert (final org.omg.CORBA.Any any, final mtnm.tmforum.org.circuitCutMgr.NameAndStringValue_T s)
	{
		any.type(type());
	...
	public static mtnm.tmforum.org.circuitCutMgr.NameAndStringValue_T read (final org.omg.CORBA.portable.InputStream in)
	{
		mtnm.tmforum.org.circuitCutMgr.NameAndStringValue_T result = new mtnm.tmforum.org.circuitCutMgr.NameAndStringValue_T();
		result.name=in.read_string();
		result.value=in.read_string();
		return result;
	}
	public static void write (final org.omg.CORBA.portable.OutputStream out, final mtnm.tmforum.org.circuitCutMgr.NameAndStringValue_T s)
	{
