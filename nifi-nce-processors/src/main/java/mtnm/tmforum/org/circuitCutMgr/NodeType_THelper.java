...
public abstract class NodeType_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(NodeType_THelper.class)
			{
				if (_type == null)
				{
					_type = org.omg.CORBA.ORB.init().create_enum_tc(mtnm.tmforum.org.circuitCutMgr.NodeType_THelper.id(),"NodeType_T",new String[]{"NODETYPE_ME","NODETYPE_TOPO_SN"});
				}
			}
		}
		return _type;
	...
	public static void insert (final org.omg.CORBA.Any any, final mtnm.tmforum.org.circuitCutMgr.NodeType_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static mtnm.tmforum.org.circuitCutMgr.NodeType_T extract (final org.omg.CORBA.Any any)
	{
