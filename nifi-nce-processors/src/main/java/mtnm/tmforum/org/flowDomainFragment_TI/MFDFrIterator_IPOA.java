...
public abstract class MFDFrIterator_IPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, mtnm.tmforum.org.flowDomainFragment_TI.MFDFrIterator_IOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				mtnm.tmforum.org.flowDomainFragment_TI.MatrixFlowDomainFragmentList_THolder _arg1= new mtnm.tmforum.org.flowDomainFragment_TI.MatrixFlowDomainFragmentList_THolder();
				_out = handler.createReply();
				_out.write_boolean(next_n(_arg0,_arg1));
				mtnm.tmforum.org.flowDomainFragment_TI.MatrixFlowDomainFragmentList_THelper.write(_out,_arg1.value);
			}
			catch(mtnm.tmforum.org.globaldefs.ProcessingFailureException _ex0)
			{
				_out = handler.createExceptionReply();
