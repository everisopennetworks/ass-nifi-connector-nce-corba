...
public class _MFDFrIterator_IStub
	...
	implements mtnm.tmforum.org.flowDomainFragment_TI.MFDFrIterator_I
{
	/** Serial version UID. */
	private static final long serialVersionUID = 1L;
	private String[] ids = {"IDL:mtnm.tmforum.org/flowDomainFragment_TI/MFDFrIterator_I:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = mtnm.tmforum.org.flowDomainFragment_TI.MFDFrIterator_IOperations.class;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mfdfrList.value = mtnm.tmforum.org.flowDomainFragment_TI.MatrixFlowDomainFragmentList_THelper.read(_is);
					return _result;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
