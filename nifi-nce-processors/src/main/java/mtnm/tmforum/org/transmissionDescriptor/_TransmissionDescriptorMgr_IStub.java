...
public class _TransmissionDescriptorMgr_IStub
	...
	implements mtnm.tmforum.org.transmissionDescriptor.TransmissionDescriptorMgr_I
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = mtnm.tmforum.org.transmissionDescriptor.TransmissionDescriptorMgr_IOperations.class;
	public void createTransmissionDescriptor(mtnm.tmforum.org.transmissionDescriptor.TMDCreateData_T newTMDCreateData, mtnm.tmforum.org.transmissionDescriptor.TransmissionDescriptor_THolder newTransmissionDescriptor) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "createTransmissionDescriptor", true);
					mtnm.tmforum.org.transmissionDescriptor.TMDCreateData_THelper.write(_os,newTMDCreateData);
					_is = _invoke(_os);
					newTransmissionDescriptor.value = mtnm.tmforum.org.transmissionDescriptor.TransmissionDescriptor_THelper.read(_is);
					return;
				}
	...
	public void deleteTransmissionDescriptor(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] transmissionDescriptorName) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "deleteTransmissionDescriptor", true);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult747 = userLabel;
_os.write_string( tmpResult747 );
	...
	public void validateTMDAssignmentToObject(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] objectName, org.omg.CORBA.StringHolder objectAssignmentState, mtnm.tmforum.org.transmissionParameters.LayeredParameterList_THolder transmissionParams, mtnm.tmforum.org.globaldefs.NVSList_THolder additionalTPInfo) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "validateTMDAssignmentToObject", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,objectName);
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,objectName);
					java.lang.String tmpResult748 = nativeEMSName;
_os.write_string( tmpResult748 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
	...
	public void setTMDAssociation(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] tmdName, mtnm.tmforum.org.transmissionDescriptor.TPorMFDorFDFr_THolder tPorMFDorFDFr) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "setTMDAssociation", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,tmdName);
					mtnm.tmforum.org.transmissionDescriptor.TPorMFDorFDFr_THelper.write(_os,tPorMFDorFDFr.value);
					_is = _invoke(_os);
					tPorMFDorFDFr.value = mtnm.tmforum.org.transmissionDescriptor.TPorMFDorFDFr_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
	...
	public void getTransmissionDescriptor(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] tmdName, mtnm.tmforum.org.transmissionDescriptor.TransmissionDescriptor_THolder tmd) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getTransmissionDescriptor", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,tmdName);
					_is = _invoke(_os);
					tmd.value = mtnm.tmforum.org.transmissionDescriptor.TransmissionDescriptor_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
	...
	public void getAllTransmissionDescriptors(int how_many, mtnm.tmforum.org.transmissionDescriptor.TransmissionDescriptorList_THolder transmissionDescList, mtnm.tmforum.org.transmissionDescriptor.TransmissionDescriptorIterator_IHolder transmissionDescIt) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getAllTransmissionDescriptors", true);
					_os.write_ulong(how_many);
					_is = _invoke(_os);
					transmissionDescList.value = mtnm.tmforum.org.transmissionDescriptor.TransmissionDescriptorList_THelper.read(_is);
					transmissionDescIt.value = mtnm.tmforum.org.transmissionDescriptor.TransmissionDescriptorIterator_IHelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
	...
	public void getAllTransmissionDescriptorNames(int how_many, mtnm.tmforum.org.globaldefs.NamingAttributesList_THolder nameList, mtnm.tmforum.org.globaldefs.NamingAttributesIterator_IHolder nameIt) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getAllTransmissionDescriptorNames", true);
					_os.write_ulong(how_many);
					_is = _invoke(_os);
	...
	public void modifyTransmissionDescriptor(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] tmdName, mtnm.tmforum.org.transmissionDescriptor.TMDModifyData_T tmdModifyData, mtnm.tmforum.org.subnetworkConnection.TPDataList_THolder tpsToModify, mtnm.tmforum.org.transmissionDescriptor.TransmissionDescriptor_THolder modifiedTransmissionDescriptor, mtnm.tmforum.org.globaldefs.NamingAttributesList_THolder failedMEList, mtnm.tmforum.org.globaldefs.NamingAttributesList_THolder failedTPsMFDsList, org.omg.CORBA.StringHolder errorReason) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "modifyTransmissionDescriptor", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,tmdName);
					mtnm.tmforum.org.transmissionDescriptor.TMDModifyData_THelper.write(_os,tmdModifyData);
					mtnm.tmforum.org.subnetworkConnection.TPDataList_THelper.write(_os,tpsToModify.value);
					mtnm.tmforum.org.transmissionDescriptor.TransmissionDescriptor_THelper.write(_os,modifiedTransmissionDescriptor.value);
					_is = _invoke(_os);
					tpsToModify.value = mtnm.tmforum.org.subnetworkConnection.TPDataList_THelper.read(_is);
					modifiedTransmissionDescriptor.value = mtnm.tmforum.org.transmissionDescriptor.TransmissionDescriptor_THelper.read(_is);
					failedMEList.value = mtnm.tmforum.org.globaldefs.NamingAttributesList_THelper.read(_is);
					failedTPsMFDsList.value = mtnm.tmforum.org.globaldefs.NamingAttributesList_THelper.read(_is);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,objectName);
					java.lang.String tmpResult749 = owner;
_os.write_string( tmpResult749 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
	...
	public void getAssociatedTPs(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] transmissionDescriptorName, int how_many, mtnm.tmforum.org.terminationPoint.TerminationPointList_THolder tpList, mtnm.tmforum.org.terminationPoint.TerminationPointIterator_IHolder tpIt) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getAssociatedTPs", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,transmissionDescriptorName);
					_os.write_ulong(how_many);
					_is = _invoke(_os);
