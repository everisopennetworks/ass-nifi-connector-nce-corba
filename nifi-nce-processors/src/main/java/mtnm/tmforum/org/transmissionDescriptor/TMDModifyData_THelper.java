...
public abstract class TMDModifyData_THelper
{
	...
	public static void insert (final org.omg.CORBA.Any any, final mtnm.tmforum.org.transmissionDescriptor.TMDModifyData_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static mtnm.tmforum.org.transmissionDescriptor.TMDModifyData_T extract (final org.omg.CORBA.Any any)
	{
	...
	public static mtnm.tmforum.org.transmissionDescriptor.TMDModifyData_T read (final org.omg.CORBA.portable.InputStream in)
	{
		mtnm.tmforum.org.transmissionDescriptor.TMDModifyData_T result = new mtnm.tmforum.org.transmissionDescriptor.TMDModifyData_T();
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final mtnm.tmforum.org.transmissionDescriptor.TMDModifyData_T s)
	{
		java.lang.String tmpResult744 = s.userLabel;
out.write_string( tmpResult744 );
		out.write_boolean(s.forceUniqueness);
		java.lang.String tmpResult745 = s.owner;
out.write_string( tmpResult745 );
		...
		java.lang.String tmpResult746 = s.externalRepresentationReference;
out.write_string( tmpResult746 );
