...
public abstract class TMDCreateData_THelper
{
	...
	public static void insert (final org.omg.CORBA.Any any, final mtnm.tmforum.org.transmissionDescriptor.TMDCreateData_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static mtnm.tmforum.org.transmissionDescriptor.TMDCreateData_T extract (final org.omg.CORBA.Any any)
	{
	...
	public static mtnm.tmforum.org.transmissionDescriptor.TMDCreateData_T read (final org.omg.CORBA.portable.InputStream in)
	{
		mtnm.tmforum.org.transmissionDescriptor.TMDCreateData_T result = new mtnm.tmforum.org.transmissionDescriptor.TMDCreateData_T();
		result.userLabel=in.read_string();
		result.forceUniqueness=in.read_boolean();
		result.owner=in.read_string();
		result.transmissionParams = mtnm.tmforum.org.transmissionParameters.LayeredParameterList_THelper.read(in);
		result.additionalObjectInfo = mtnm.tmforum.org.globaldefs.NVSList_THelper.read(in);
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final mtnm.tmforum.org.transmissionDescriptor.TMDCreateData_T s)
	{
		java.lang.String tmpResult741 = s.userLabel;
out.write_string( tmpResult741 );
		out.write_boolean(s.forceUniqueness);
		java.lang.String tmpResult742 = s.owner;
out.write_string( tmpResult742 );
		mtnm.tmforum.org.transmissionParameters.LayeredParameterList_THelper.write(out,s.transmissionParams);
		mtnm.tmforum.org.globaldefs.NVSList_THelper.write(out,s.additionalObjectInfo);
		mtnm.tmforum.org.globaldefs.NVSList_THelper.write(out,s.containingTMDName);
		java.lang.String tmpResult743 = s.externalRepresentationReference;
out.write_string( tmpResult743 );
