...
public class _TopologicalLinkIterator_IStub
	...
	implements mtnm.tmforum.org.topologicalLink.TopologicalLinkIterator_I
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = mtnm.tmforum.org.topologicalLink.TopologicalLinkIterator_IOperations.class;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					topoLinkList.value = mtnm.tmforum.org.topologicalLink.TopologicalLinkList_THelper.read(_is);
					return _result;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
