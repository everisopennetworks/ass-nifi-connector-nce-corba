...
public class _Common_IStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements mtnm.tmforum.org.common.Common_I
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = mtnm.tmforum.org.common.Common_IOperations.class;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult11 = owner;
_os.write_string( tmpResult11 );
		...
		else
		{
			...
			if( _so == null )
				continue;
			Common_IOperations _localServant = (Common_IOperations)_so.servant;
			try
			{
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,objectName);
					java.lang.String tmpResult12 = userLabel;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,objectName);
					java.lang.String tmpResult13 = nativeEMSName;
