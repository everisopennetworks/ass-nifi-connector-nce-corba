...
public interface TrafficDescriptorIterator_IOperations
{
	/* constants */
	/* operations  */
	boolean next_n(int how_many, mtnm.tmforum.org.trafficDescriptor.TrafficDescriptorList_THolder trafficDescList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException;
