...
public abstract class PMPIterator_IPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, mtnm.tmforum.org.performance.PMPIterator_IOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				mtnm.tmforum.org.performance.PMPList_THolder _arg1= new mtnm.tmforum.org.performance.PMPList_THolder();
				_out = handler.createReply();
				_out.write_boolean(next_n(_arg0,_arg1));
				mtnm.tmforum.org.performance.PMPList_THelper.write(_out,_arg1.value);
			}
			catch(mtnm.tmforum.org.globaldefs.ProcessingFailureException _ex0)
			{
				_out = handler.createExceptionReply();
