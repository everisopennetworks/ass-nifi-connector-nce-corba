...
/**
 * Generated from IDL alias "CollectTaskInfoList_T".
 *
 * @author JacORB IDL compiler V 3.9
 * @version generated at 13/07/2021 04:51:40 PM
 */

public abstract class CollectTaskInfoList_THelper
{
	private volatile static org.omg.CORBA.TypeCode _type;

	public static void insert (org.omg.CORBA.Any any, mtnm.tmforum.org.performance.CollectTaskInfo_T[] s)
	{
		any.type (type ());
	...
	{
		return "IDL:mtnm.tmforum.org/performance/CollectTaskInfoList_T:1.0";
	}
	public static mtnm.tmforum.org.performance.CollectTaskInfo_T[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		mtnm.tmforum.org.performance.CollectTaskInfo_T[] _result;
		...
		_result = new mtnm.tmforum.org.performance.CollectTaskInfo_T[_l_result146];
		for (int i=0;i<_result.length;i++)
		{
			_result[i]=mtnm.tmforum.org.performance.CollectTaskInfo_THelper.read(_in);
		}

		return _result;
	}

	public static void write (final org.omg.CORBA.portable.OutputStream _out, mtnm.tmforum.org.performance.CollectTaskInfo_T[] _s)
	{
		
		_out.write_long(_s.length);
		for (int i=0; i<_s.length;i++)
		{
			mtnm.tmforum.org.performance.CollectTaskInfo_THelper.write(_out,_s[i]);
		}
