...
public abstract class PMState_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(PMState_THelper.class)
			{
				if (_type == null)
				{
	...
	public static void insert (final org.omg.CORBA.Any any, final mtnm.tmforum.org.performance.PMState_T s)
	{
		any.type(type());
	...
	public static mtnm.tmforum.org.performance.PMState_T read (final org.omg.CORBA.portable.InputStream in)
	{
		mtnm.tmforum.org.performance.PMState_T result = new mtnm.tmforum.org.performance.PMState_T();
		...
		result.pmEventStateList = mtnm.tmforum.org.performance.PMEventStateList_THelper.read(in);
		return result;
	}
	public static void write (final org.omg.CORBA.portable.OutputStream out, final mtnm.tmforum.org.performance.PMState_T s)
	{
		mtnm.tmforum.org.globaldefs.NVSList_THelper.write(out,s.tpName);
		out.write_short(s.layerRate);
		java.lang.String tmpResult560 = s.granularity;
out.write_string( tmpResult560 );
		mtnm.tmforum.org.performance.PMEventStateList_THelper.write(out,s.pmEventStateList);
	}
}
