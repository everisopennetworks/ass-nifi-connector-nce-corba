...
public class _PMStateIterator_IStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements mtnm.tmforum.org.performance.PMStateIterator_I
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = mtnm.tmforum.org.performance.PMStateIterator_IOperations.class;
	public int getLength() throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			PMStateIterator_IOperations _localServant = (PMStateIterator_IOperations)_so.servant;
			int _result;
			try
			{
	...
	public boolean next_n(int how_many, mtnm.tmforum.org.performance.PMStateList_THolder pmStateList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
		...
		else
		{
			...
			try
			{
				_result = _localServant.next_n(how_many,pmStateList);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
