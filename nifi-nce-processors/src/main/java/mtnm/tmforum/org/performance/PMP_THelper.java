...
public abstract class PMP_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(PMP_THelper.class)
			{
				if (_type == null)
				{
	...
	public static void insert (final org.omg.CORBA.Any any, final mtnm.tmforum.org.performance.PMP_T s)
	{
		any.type(type());
	...
	public static mtnm.tmforum.org.performance.PMP_T read (final org.omg.CORBA.portable.InputStream in)
	{
		mtnm.tmforum.org.performance.PMP_T result = new mtnm.tmforum.org.performance.PMP_T();
		result.name = mtnm.tmforum.org.globaldefs.NVSList_THelper.read(in);
		result.userLabel=in.read_string();
		result.nativeEMSName=in.read_string();
		result.owner=in.read_string();
		result.pmParameterWithThresholdsList = mtnm.tmforum.org.performance.PMParameterWithThresholdsList_THelper.read(in);
		result.monitoringState=mtnm.tmforum.org.performance.AdministrativeState_THelper.read(in);
		result.supervisionState=mtnm.tmforum.org.performance.AdministrativeState_THelper.read(in);
		result.additionalInfo = mtnm.tmforum.org.globaldefs.NVSList_THelper.read(in);
		return result;
	}
	public static void write (final org.omg.CORBA.portable.OutputStream out, final mtnm.tmforum.org.performance.PMP_T s)
	{
		mtnm.tmforum.org.globaldefs.NVSList_THelper.write(out,s.name);
		java.lang.String tmpResult564 = s.userLabel;
out.write_string( tmpResult564 );
		java.lang.String tmpResult565 = s.nativeEMSName;
out.write_string( tmpResult565 );
		java.lang.String tmpResult566 = s.owner;
out.write_string( tmpResult566 );
		mtnm.tmforum.org.performance.PMParameterWithThresholdsList_THelper.write(out,s.pmParameterWithThresholdsList);
		mtnm.tmforum.org.performance.AdministrativeState_THelper.write(out,s.monitoringState);
		mtnm.tmforum.org.performance.AdministrativeState_THelper.write(out,s.supervisionState);
