...
public interface PMStateIterator_IOperations
{
	/* constants */
	/* operations  */
	boolean next_n(int how_many, mtnm.tmforum.org.performance.PMStateList_THolder pmStateList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException;
