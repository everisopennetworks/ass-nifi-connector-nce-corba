...
public abstract class FDCreateData_THelper
{
	...
	public static void insert (final org.omg.CORBA.Any any, final mtnm.tmforum.org.flowDomain_TI.FDCreateData_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static mtnm.tmforum.org.flowDomain_TI.FDCreateData_T extract (final org.omg.CORBA.Any any)
	{
	...
	{
		return "IDL:mtnm.tmforum.org/flowDomain_TI/FDCreateData_T:1.0";
	}
	public static mtnm.tmforum.org.flowDomain_TI.FDCreateData_T read (final org.omg.CORBA.portable.InputStream in)
	{
		mtnm.tmforum.org.flowDomain_TI.FDCreateData_T result = new mtnm.tmforum.org.flowDomain_TI.FDCreateData_T();
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final mtnm.tmforum.org.flowDomain_TI.FDCreateData_T s)
	{
		mtnm.tmforum.org.globaldefs.NVSList_THelper.write(out,s.name);
		java.lang.String tmpResult265 = s.userLabel;
out.write_string( tmpResult265 );
		out.write_boolean(s.forceUniqueness);
		java.lang.String tmpResult266 = s.owner;
out.write_string( tmpResult266 );
		java.lang.String tmpResult267 = s.networkAccessDomain;
out.write_string( tmpResult267 );
