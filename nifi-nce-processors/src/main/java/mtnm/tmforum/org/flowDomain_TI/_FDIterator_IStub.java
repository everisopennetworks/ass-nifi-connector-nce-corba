...
public class _FDIterator_IStub
	...
	implements mtnm.tmforum.org.flowDomain_TI.FDIterator_I
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = mtnm.tmforum.org.flowDomain_TI.FDIterator_IOperations.class;
	...
	public boolean next_n(int how_many, mtnm.tmforum.org.flowDomain_TI.FDList_THolder fdList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					fdList.value = mtnm.tmforum.org.flowDomain_TI.FDList_THelper.read(_is);
					return _result;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
