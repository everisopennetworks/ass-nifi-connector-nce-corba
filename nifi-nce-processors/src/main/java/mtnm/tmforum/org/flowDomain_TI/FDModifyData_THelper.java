...
public abstract class FDModifyData_THelper
{
	...
	public static void insert (final org.omg.CORBA.Any any, final mtnm.tmforum.org.flowDomain_TI.FDModifyData_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static mtnm.tmforum.org.flowDomain_TI.FDModifyData_T extract (final org.omg.CORBA.Any any)
	{
	...
	{
		return "IDL:mtnm.tmforum.org/flowDomain_TI/FDModifyData_T:1.0";
	}
	public static mtnm.tmforum.org.flowDomain_TI.FDModifyData_T read (final org.omg.CORBA.portable.InputStream in)
	{
		mtnm.tmforum.org.flowDomain_TI.FDModifyData_T result = new mtnm.tmforum.org.flowDomain_TI.FDModifyData_T();
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final mtnm.tmforum.org.flowDomain_TI.FDModifyData_T s)
	{
		java.lang.String tmpResult268 = s.userLabel;
out.write_string( tmpResult268 );
		out.write_boolean(s.forceUniqueness);
		java.lang.String tmpResult269 = s.owner;
out.write_string( tmpResult269 );
		java.lang.String tmpResult270 = s.networkAccessDomain;
out.write_string( tmpResult270 );
