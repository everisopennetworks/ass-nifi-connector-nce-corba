...
public class _NmsSession_IStub
	...
	implements mtnm.tmforum.org.nmsSession.NmsSession_I
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = mtnm.tmforum.org.nmsSession.NmsSession_IOperations.class;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult529 = startTime;
_os.write_string( tmpResult529 );
					java.lang.String tmpResult530 = notificationId;
_os.write_string( tmpResult530 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult531 = endTime;
_os.write_string( tmpResult531 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
