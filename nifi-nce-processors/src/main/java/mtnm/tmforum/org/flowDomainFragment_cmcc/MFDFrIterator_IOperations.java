...
public interface MFDFrIterator_IOperations
{
	/* constants */
	/* operations  */
	boolean next_n(int how_many, mtnm.tmforum.org.flowDomainFragment_cmcc.MatrixFlowDomainFragmentList_THolder mfdfrList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException;
