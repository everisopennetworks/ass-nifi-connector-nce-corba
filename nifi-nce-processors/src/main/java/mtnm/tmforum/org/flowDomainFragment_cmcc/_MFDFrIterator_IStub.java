...
public class _MFDFrIterator_IStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements mtnm.tmforum.org.flowDomainFragment_cmcc.MFDFrIterator_I
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = mtnm.tmforum.org.flowDomainFragment_cmcc.MFDFrIterator_IOperations.class;
	public int getLength() throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			MFDFrIterator_IOperations _localServant = (MFDFrIterator_IOperations)_so.servant;
			int _result;
			try
			{
	...
	public boolean next_n(int how_many, mtnm.tmforum.org.flowDomainFragment_cmcc.MatrixFlowDomainFragmentList_THolder mfdfrList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mfdfrList.value = mtnm.tmforum.org.flowDomainFragment_cmcc.MatrixFlowDomainFragmentList_THelper.read(_is);
					return _result;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
