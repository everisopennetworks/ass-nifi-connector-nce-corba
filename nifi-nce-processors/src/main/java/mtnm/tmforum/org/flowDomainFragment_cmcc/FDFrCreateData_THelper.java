...
public abstract class FDFrCreateData_THelper
{
	...
	public static void insert (final org.omg.CORBA.Any any, final mtnm.tmforum.org.flowDomainFragment_cmcc.FDFrCreateData_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static mtnm.tmforum.org.flowDomainFragment_cmcc.FDFrCreateData_T extract (final org.omg.CORBA.Any any)
	{
	...
	public static mtnm.tmforum.org.flowDomainFragment_cmcc.FDFrCreateData_T read (final org.omg.CORBA.portable.InputStream in)
	{
		mtnm.tmforum.org.flowDomainFragment_cmcc.FDFrCreateData_T result = new mtnm.tmforum.org.flowDomainFragment_cmcc.FDFrCreateData_T();
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final mtnm.tmforum.org.flowDomainFragment_cmcc.FDFrCreateData_T s)
	{
		mtnm.tmforum.org.globaldefs.NVSList_THelper.write(out,s.name);
		java.lang.String tmpResult185 = s.userLabel;
out.write_string( tmpResult185 );
		out.write_boolean(s.forceUniqueness);
		java.lang.String tmpResult186 = s.owner;
out.write_string( tmpResult186 );
		java.lang.String tmpResult187 = s.networkAccessDomain;
out.write_string( tmpResult187 );
		...
		java.lang.String tmpResult188 = s.fdfrType;
out.write_string( tmpResult188 );
