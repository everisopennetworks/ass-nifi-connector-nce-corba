...
public class _MFDIterator_IStub
	...
	implements mtnm.tmforum.org.flowDomain.MFDIterator_I
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = mtnm.tmforum.org.flowDomain.MFDIterator_IOperations.class;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mfdList.value = mtnm.tmforum.org.flowDomain.MFDList_THelper.read(_is);
					return _result;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
