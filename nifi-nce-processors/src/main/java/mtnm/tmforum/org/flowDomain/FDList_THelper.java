...
public abstract class FDList_THelper
{
	...
	public static void insert (org.omg.CORBA.Any any, mtnm.tmforum.org.flowDomain.FlowDomain_T[] s)
	{
		any.type (type ());
	...
	public static mtnm.tmforum.org.flowDomain.FlowDomain_T[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		mtnm.tmforum.org.flowDomain.FlowDomain_T[] _result;
		...
		_result = new mtnm.tmforum.org.flowDomain.FlowDomain_T[_l_result34];
		for (int i=0;i<_result.length;i++)
		{
			_result[i]=mtnm.tmforum.org.flowDomain.FlowDomain_THelper.read(_in);
		}

		return _result;
	}

	public static void write (final org.omg.CORBA.portable.OutputStream _out, mtnm.tmforum.org.flowDomain.FlowDomain_T[] _s)
	{
		
		_out.write_long(_s.length);
		for (int i=0; i<_s.length;i++)
		{
			mtnm.tmforum.org.flowDomain.FlowDomain_THelper.write(_out,_s[i]);
		}
