...
public abstract class FDModifyData_THelper
{
	...
	public static void insert (final org.omg.CORBA.Any any, final mtnm.tmforum.org.flowDomain.FDModifyData_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static mtnm.tmforum.org.flowDomain.FDModifyData_T extract (final org.omg.CORBA.Any any)
	{
	...
	public static mtnm.tmforum.org.flowDomain.FDModifyData_T read (final org.omg.CORBA.portable.InputStream in)
	{
		mtnm.tmforum.org.flowDomain.FDModifyData_T result = new mtnm.tmforum.org.flowDomain.FDModifyData_T();
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final mtnm.tmforum.org.flowDomain.FDModifyData_T s)
	{
		java.lang.String tmpResult136 = s.userLabel;
out.write_string( tmpResult136 );
		out.write_boolean(s.forceUniqueness);
		java.lang.String tmpResult137 = s.owner;
out.write_string( tmpResult137 );
		java.lang.String tmpResult138 = s.networkAccessDomain;
out.write_string( tmpResult138 );
