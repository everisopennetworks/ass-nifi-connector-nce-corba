...
public abstract class MFDCreateData_THelper
{
	...
	public static void insert (final org.omg.CORBA.Any any, final mtnm.tmforum.org.flowDomain.MFDCreateData_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static mtnm.tmforum.org.flowDomain.MFDCreateData_T extract (final org.omg.CORBA.Any any)
	{
	...
	public static mtnm.tmforum.org.flowDomain.MFDCreateData_T read (final org.omg.CORBA.portable.InputStream in)
	{
		mtnm.tmforum.org.flowDomain.MFDCreateData_T result = new mtnm.tmforum.org.flowDomain.MFDCreateData_T();
		...
		result.unassignedCPTPs = mtnm.tmforum.org.globaldefs.NamingAttributesList_THelper.read(in);
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final mtnm.tmforum.org.flowDomain.MFDCreateData_T s)
	{
		mtnm.tmforum.org.globaldefs.NVSList_THelper.write(out,s.name);
		java.lang.String tmpResult147 = s.userLabel;
out.write_string( tmpResult147 );
		out.write_boolean(s.forceUniqueness);
		java.lang.String tmpResult148 = s.owner;
out.write_string( tmpResult148 );
		java.lang.String tmpResult149 = s.networkAccessDomain;
out.write_string( tmpResult149 );
		mtnm.tmforum.org.globaldefs.NamingAttributesList_THelper.write(out,s.transmissionDescriptorName);
		mtnm.tmforum.org.globaldefs.NamingAttributesList_THelper.write(out,s.unassignedCPTPs);
