...
public abstract class MFDIterator_IPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, mtnm.tmforum.org.flowDomain_cmcc.MFDIterator_IOperations
{
	...
	private String[] ids = {"IDL:mtnm.tmforum.org/flowDomain_cmcc/MFDIterator_I:1.0"};
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				mtnm.tmforum.org.flowDomain_cmcc.MFDList_THolder _arg1= new mtnm.tmforum.org.flowDomain_cmcc.MFDList_THolder();
				_out = handler.createReply();
				_out.write_boolean(next_n(_arg0,_arg1));
				mtnm.tmforum.org.flowDomain_cmcc.MFDList_THelper.write(_out,_arg1.value);
			}
			catch(mtnm.tmforum.org.globaldefs.ProcessingFailureException _ex0)
			{
				_out = handler.createExceptionReply();
