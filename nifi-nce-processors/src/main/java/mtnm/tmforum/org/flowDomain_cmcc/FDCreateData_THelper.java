...
public abstract class FDCreateData_THelper
{
	...
	public static void insert (final org.omg.CORBA.Any any, final mtnm.tmforum.org.flowDomain_cmcc.FDCreateData_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static mtnm.tmforum.org.flowDomain_cmcc.FDCreateData_T extract (final org.omg.CORBA.Any any)
	{
	...
	{
		return "IDL:mtnm.tmforum.org/flowDomain_cmcc/FDCreateData_T:1.0";
	}
	public static mtnm.tmforum.org.flowDomain_cmcc.FDCreateData_T read (final org.omg.CORBA.portable.InputStream in)
	{
		mtnm.tmforum.org.flowDomain_cmcc.FDCreateData_T result = new mtnm.tmforum.org.flowDomain_cmcc.FDCreateData_T();
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final mtnm.tmforum.org.flowDomain_cmcc.FDCreateData_T s)
	{
		mtnm.tmforum.org.globaldefs.NVSList_THelper.write(out,s.name);
		java.lang.String tmpResult214 = s.userLabel;
out.write_string( tmpResult214 );
		out.write_boolean(s.forceUniqueness);
		java.lang.String tmpResult215 = s.owner;
out.write_string( tmpResult215 );
		java.lang.String tmpResult216 = s.networkAccessDomain;
out.write_string( tmpResult216 );
