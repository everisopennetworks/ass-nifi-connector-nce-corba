...
public abstract class FTPCreateData_THelper
{
	...
	public static void insert (final org.omg.CORBA.Any any, final mtnm.tmforum.org.flowDomain_cmcc.FTPCreateData_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static mtnm.tmforum.org.flowDomain_cmcc.FTPCreateData_T extract (final org.omg.CORBA.Any any)
	{
	...
	{
		return "IDL:mtnm.tmforum.org/flowDomain_cmcc/FTPCreateData_T:1.0";
	}
	public static mtnm.tmforum.org.flowDomain_cmcc.FTPCreateData_T read (final org.omg.CORBA.portable.InputStream in)
	{
		mtnm.tmforum.org.flowDomain_cmcc.FTPCreateData_T result = new mtnm.tmforum.org.flowDomain_cmcc.FTPCreateData_T();
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final mtnm.tmforum.org.flowDomain_cmcc.FTPCreateData_T s)
	{
		mtnm.tmforum.org.globaldefs.NVSList_THelper.write(out,s.equipmentName);
		java.lang.String tmpResult224 = s.userLabel;
out.write_string( tmpResult224 );
		out.write_boolean(s.forceUniqueness);
		java.lang.String tmpResult225 = s.owner;
out.write_string( tmpResult225 );
		java.lang.String tmpResult226 = s.networkAccessDomain;
out.write_string( tmpResult226 );
