...
public abstract class MFDModifyData_THelper
{
	...
	public static void insert (final org.omg.CORBA.Any any, final mtnm.tmforum.org.flowDomain_cmcc.MFDModifyData_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static mtnm.tmforum.org.flowDomain_cmcc.MFDModifyData_T extract (final org.omg.CORBA.Any any)
	{
	...
	{
		return "IDL:mtnm.tmforum.org/flowDomain_cmcc/MFDModifyData_T:1.0";
	}
	public static mtnm.tmforum.org.flowDomain_cmcc.MFDModifyData_T read (final org.omg.CORBA.portable.InputStream in)
	{
		mtnm.tmforum.org.flowDomain_cmcc.MFDModifyData_T result = new mtnm.tmforum.org.flowDomain_cmcc.MFDModifyData_T();
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final mtnm.tmforum.org.flowDomain_cmcc.MFDModifyData_T s)
	{
		java.lang.String tmpResult230 = s.userLabel;
out.write_string( tmpResult230 );
		out.write_boolean(s.forceUniqueness);
		java.lang.String tmpResult231 = s.owner;
out.write_string( tmpResult231 );
		java.lang.String tmpResult232 = s.networkAccessDomain;
out.write_string( tmpResult232 );
