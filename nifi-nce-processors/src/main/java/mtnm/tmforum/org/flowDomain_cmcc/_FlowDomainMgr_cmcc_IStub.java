...
public class _FlowDomainMgr_cmcc_IStub
	...
	implements mtnm.tmforum.org.flowDomain_cmcc.FlowDomainMgr_cmcc_I
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = mtnm.tmforum.org.flowDomain_cmcc.FlowDomainMgr_cmcc_IOperations.class;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mtnm.tmforum.org.flowDomain_cmcc.MFDCreateData_THelper.write(_os,createData);
					...
					theMFD.value = mtnm.tmforum.org.flowDomain_cmcc.MatrixFlowDomain_THelper.read(_is);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					_is = _invoke(_os);
					mfd.value = mtnm.tmforum.org.flowDomain_cmcc.MatrixFlowDomain_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mtnm.tmforum.org.flowDomain_cmcc.FDModifyData_THelper.write(_os,fdModifyData);
					_is = _invoke(_os);
					modifiedFD.value = mtnm.tmforum.org.flowDomain_cmcc.FlowDomain_THelper.read(_is);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mtnm.tmforum.org.flowDomain_cmcc.ParameterGroupsList_THelper.write(_os,filter);
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,fdName);
					mtnm.tmforum.org.globaldefs.NamingAttributesList_THelper.write(_os,cptpNames);
					mtnm.tmforum.org.subnetworkConnection.TPDataList_THelper.write(_os,tpsToModify.value);
					_is = _invoke(_os);
					tpsToModify.value = mtnm.tmforum.org.subnetworkConnection.TPDataList_THelper.read(_is);
					errorReason.value = _is.read_string();
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult233 = owner;
_os.write_string( tmpResult233 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult234 = userLabel;
_os.write_string( tmpResult234 );
					_is = _invoke(_os);
					flowDomains.value = mtnm.tmforum.org.flowDomain_cmcc.FDList_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mtnm.tmforum.org.flowDomainFragment_cmcc.FDFrCreateData_THelper.write(_os,createData);
					mtnm.tmforum.org.flowDomain_cmcc.ConnectivityRequirement_THelper.write(_os,connectivityRequirement);
					...
					mtnm.tmforum.org.flowDomainFragment_cmcc.MatrixFlowDomainFragmentList_THelper.write(_os,mfdfrs.value);
					mtnm.tmforum.org.subnetworkConnection.TPDataList_THelper.write(_os,tpsToModify.value);
					_is = _invoke(_os);
					internalTPs.value = mtnm.tmforum.org.globaldefs.NamingAttributesList_THelper.read(_is);
					mfdfrs.value = mtnm.tmforum.org.flowDomainFragment_cmcc.MatrixFlowDomainFragmentList_THelper.read(_is);
					tpsToModify.value = mtnm.tmforum.org.subnetworkConnection.TPDataList_THelper.read(_is);
					theFDFr.value = mtnm.tmforum.org.flowDomainFragment_cmcc.FlowDomainFragment_THelper.read(_is);
	...
	public void getAllAssociatedMFDs(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] tmdOrFdName, int how_many, mtnm.tmforum.org.flowDomain_cmcc.MFDList_THolder mfds, mtnm.tmforum.org.flowDomain_cmcc.MFDIterator_IHolder mfdIt) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getAllAssociatedMFDs", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,tmdOrFdName);
					_os.write_ulong(how_many);
					_is = _invoke(_os);
					mfds.value = mtnm.tmforum.org.flowDomain_cmcc.MFDList_THelper.read(_is);
					mfdIt.value = mtnm.tmforum.org.flowDomain_cmcc.MFDIterator_IHelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
	...
	public void getAllAssignableCPTPs(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] mfdName, int how_many, mtnm.tmforum.org.terminationPoint.TerminationPointList_THolder cptpList, mtnm.tmforum.org.terminationPoint.TerminationPointIterator_IHolder cptpIt) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getAllAssignableCPTPs", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,mfdName);
					_os.write_ulong(how_many);
					_is = _invoke(_os);
					cptpList.value = mtnm.tmforum.org.terminationPoint.TerminationPointList_THelper.read(_is);
					cptpIt.value = mtnm.tmforum.org.terminationPoint.TerminationPointIterator_IHelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mtnm.tmforum.org.flowDomainFragment_cmcc.FDFrModifyData_THelper.write(_os,fdfrModifyData);
					mtnm.tmforum.org.flowDomain_cmcc.ConnectivityRequirement_THelper.write(_os,connectivityRequirement);
					mtnm.tmforum.org.subnetworkConnection.TPDataList_THelper.write(_os,tpsToModify.value);
					_is = _invoke(_os);
					tpsToModify.value = mtnm.tmforum.org.subnetworkConnection.TPDataList_THelper.read(_is);
					...
					parameterProblemsTPList.value = mtnm.tmforum.org.globaldefs.NamingAttributesList_THelper.read(_is);
					newFDFr.value = mtnm.tmforum.org.flowDomainFragment_cmcc.FlowDomainFragment_THelper.read(_is);
					errorReason.value = _is.read_string();
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,fdName);
					mtnm.tmforum.org.flowDomain_cmcc.CPTP_Role_THelper.write(_os,cptpRole);
					_os.write_ulong(how_many);
					_is = _invoke(_os);
					cptpList.value = mtnm.tmforum.org.terminationPoint.TerminationPointList_THelper.read(_is);
					cptpIt.value = mtnm.tmforum.org.terminationPoint.TerminationPointIterator_IHelper.read(_is);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					fdfrIt.value = mtnm.tmforum.org.flowDomainFragment_cmcc.FDFrIterator_IHelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
	...
	public void getAllTopologicalLinksOfFD(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] flowDomainName, int how_many, mtnm.tmforum.org.topologicalLink.TopologicalLinkList_THolder topoList, mtnm.tmforum.org.topologicalLink.TopologicalLinkIterator_IHolder topoIt) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getAllTopologicalLinksOfFD", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,flowDomainName);
					_os.write_ulong(how_many);
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mtnm.tmforum.org.flowDomain_cmcc.FDCreateData_THelper.write(_os,createData);
					mtnm.tmforum.org.globaldefs.NamingAttributesList_THelper.write(_os,assignedCPTPs.value);
					mtnm.tmforum.org.subnetworkConnection.TPDataList_THelper.write(_os,tpsToModify.value);
					_is = _invoke(_os);
					assignedCPTPs.value = mtnm.tmforum.org.globaldefs.NamingAttributesList_THelper.read(_is);
					tpsToModify.value = mtnm.tmforum.org.subnetworkConnection.TPDataList_THelper.read(_is);
					theFD.value = mtnm.tmforum.org.flowDomain_cmcc.FlowDomain_THelper.read(_is);
					errorReason.value = _is.read_string();
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mtnm.tmforum.org.flowDomain_cmcc.FTPCreateData_THelper.write(_os,createData);
					mtnm.tmforum.org.subnetworkConnection.TPDataList_THelper.write(_os,tpsToModify.value);
					_is = _invoke(_os);
					tpsToModify.value = mtnm.tmforum.org.subnetworkConnection.TPDataList_THelper.read(_is);
	...
	public void getAllAssignedCPTPs(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] mfdName, int how_many, mtnm.tmforum.org.terminationPoint.TerminationPointList_THolder cptpList, mtnm.tmforum.org.terminationPoint.TerminationPointIterator_IHolder cptpIt) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getAllAssignedCPTPs", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,mfdName);
					_os.write_ulong(how_many);
					_is = _invoke(_os);
					cptpList.value = mtnm.tmforum.org.terminationPoint.TerminationPointList_THelper.read(_is);
	...
	public void getAssociatingFD(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] mfdName, mtnm.tmforum.org.flowDomain_cmcc.FlowDomain_THolder flowDomain) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getAssociatingFD", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,mfdName);
					_is = _invoke(_os);
					flowDomain.value = mtnm.tmforum.org.flowDomain_cmcc.FlowDomain_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,fdfrName);
					_is = _invoke(_os);
					fdfr.value = mtnm.tmforum.org.flowDomainFragment_cmcc.FlowDomainFragment_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
	...
	public void getAllSupportedMFDs(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] holderName, int how_many, mtnm.tmforum.org.flowDomain_cmcc.MFDList_THolder mfds, mtnm.tmforum.org.flowDomain_cmcc.MFDIterator_IHolder mfdIt) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getAllSupportedMFDs", true);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult235 = userLabel;
_os.write_string( tmpResult235 );
					_is = _invoke(_os);
					fdfrs.value = mtnm.tmforum.org.flowDomainFragment_cmcc.FDFrList_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,objectName);
					java.lang.String tmpResult236 = userLabel;
_os.write_string( tmpResult236 );
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					_is = _invoke(_os);
					flowDomains.value = mtnm.tmforum.org.flowDomain_cmcc.FDList_THelper.read(_is);
					fdIt.value = mtnm.tmforum.org.flowDomain_cmcc.FDIterator_IHelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,mfdName);
					mtnm.tmforum.org.flowDomain_cmcc.MFDModifyData_THelper.write(_os,mfdModifyData);
					_is = _invoke(_os);
					newMFD.value = mtnm.tmforum.org.flowDomain_cmcc.MatrixFlowDomain_THelper.read(_is);
					failedAttributes.value = _is.read_string();
					errorReason.value = _is.read_string();
					return;
				}
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mtnm.tmforum.org.flowDomainFragment_cmcc.FDFrCreateData_THelper.write(_os,createData);
					mtnm.tmforum.org.flowDomain_cmcc.ConnectivityRequirement_THelper.write(_os,connectivityRequirement);
					mtnm.tmforum.org.subnetworkConnection.TPDataList_THelper.write(_os,aEnd);
					mtnm.tmforum.org.subnetworkConnection.TPDataList_THelper.write(_os,zEnd);
					mtnm.tmforum.org.globaldefs.NamingAttributesList_THelper.write(_os,internalTPs.value);
					mtnm.tmforum.org.flowDomainFragment_cmcc.MatrixFlowDomainFragmentList_THelper.write(_os,mfdfrs.value);
					mtnm.tmforum.org.subnetworkConnection.TPDataList_THelper.write(_os,tpsToModify.value);
					_is = _invoke(_os);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,objectName);
					java.lang.String tmpResult237 = nativeEMSName;
_os.write_string( tmpResult237 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,fdfrName);
					_is = _invoke(_os);
					route.value = mtnm.tmforum.org.flowDomainFragment_cmcc.FDFrRoute_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
