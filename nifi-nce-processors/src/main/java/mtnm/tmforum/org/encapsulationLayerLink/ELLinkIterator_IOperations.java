...
public interface ELLinkIterator_IOperations
{
	/* constants */
	/* operations  */
	boolean next_n(int how_many, mtnm.tmforum.org.encapsulationLayerLink.ELLinkList_THolder ellList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException;
