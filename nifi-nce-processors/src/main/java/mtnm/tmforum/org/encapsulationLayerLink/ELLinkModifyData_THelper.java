...
public abstract class ELLinkModifyData_THelper
{
	...
	public static void insert (final org.omg.CORBA.Any any, final mtnm.tmforum.org.encapsulationLayerLink.ELLinkModifyData_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static mtnm.tmforum.org.encapsulationLayerLink.ELLinkModifyData_T extract (final org.omg.CORBA.Any any)
	{
	...
	public static mtnm.tmforum.org.encapsulationLayerLink.ELLinkModifyData_T read (final org.omg.CORBA.portable.InputStream in)
	{
		mtnm.tmforum.org.encapsulationLayerLink.ELLinkModifyData_T result = new mtnm.tmforum.org.encapsulationLayerLink.ELLinkModifyData_T();
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final mtnm.tmforum.org.encapsulationLayerLink.ELLinkModifyData_T s)
	{
		java.lang.String tmpResult71 = s.userLabel;
out.write_string( tmpResult71 );
		out.write_boolean(s.forceUniqueness);
		java.lang.String tmpResult72 = s.owner;
out.write_string( tmpResult72 );
		java.lang.String tmpResult73 = s.networkAccessDomain;
