...
public class _GuiCutThroughMgr_IStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements mtnm.tmforum.org.guiCutThrough.GuiCutThroughMgr_I
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = mtnm.tmforum.org.guiCutThrough.GuiCutThroughMgr_IOperations.class;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult291 = owner;
_os.write_string( tmpResult291 );
					_is = _invoke(_os);
					return;
				}
		...
		else
		{
			...
			if( _so == null )
				continue;
			GuiCutThroughMgr_IOperations _localServant = (GuiCutThroughMgr_IOperations)_so.servant;
			try
			{
	...
	public void getGCTProfileInfo(mtnm.tmforum.org.guiCutThrough.GCTProfileInfo_THolder gctProfileInfo) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getGCTProfileInfo", true);
					_is = _invoke(_os);
					gctProfileInfo.value = mtnm.tmforum.org.guiCutThrough.GCTProfileInfo_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "getGCTProfileInfo", _opsClass );
			if( _so == null )
				continue;
			GuiCutThroughMgr_IOperations _localServant = (GuiCutThroughMgr_IOperations)_so.servant;
			try
			{
				_localServant.getGCTProfileInfo(gctProfileInfo);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
	...
	public void launchGCT(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] objectName, java.lang.String gctContext, mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] userInfo, java.lang.String displayAddress, mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] additionalInputInfo, org.omg.CORBA.BooleanHolder closingEnabled, mtnm.tmforum.org.globaldefs.NVSList_THolder additionalOutputInfo) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "launchGCT", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,objectName);
					java.lang.String tmpResult292 = gctContext;
_os.write_string( tmpResult292 );
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,userInfo);
					java.lang.String tmpResult293 = displayAddress;
_os.write_string( tmpResult293 );
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,additionalInputInfo);
					_is = _invoke(_os);
					closingEnabled.value = _is.read_boolean();
					additionalOutputInfo.value = mtnm.tmforum.org.globaldefs.NVSList_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "launchGCT", _opsClass );
			if( _so == null )
				continue;
			GuiCutThroughMgr_IOperations _localServant = (GuiCutThroughMgr_IOperations)_so.servant;
			try
			{
				_localServant.launchGCT(objectName,gctContext,userInfo,displayAddress,additionalInputInfo,closingEnabled,additionalOutputInfo);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
	...
	public void destroyGCT(java.lang.String displayAddress) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "destroyGCT", true);
					java.lang.String tmpResult294 = displayAddress;
_os.write_string( tmpResult294 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "destroyGCT", _opsClass );
			if( _so == null )
				continue;
			GuiCutThroughMgr_IOperations _localServant = (GuiCutThroughMgr_IOperations)_so.servant;
			try
			{
				_localServant.destroyGCT(displayAddress);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,objectName);
					java.lang.String tmpResult295 = nativeEMSName;
_os.write_string( tmpResult295 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,objectName);
					java.lang.String tmpResult296 = userLabel;
_os.write_string( tmpResult296 );
