...
public interface TCProfileIterator_IOperations
{
	/* constants */
	/* operations  */
	boolean next_n(int how_many, mtnm.tmforum.org.trafficConditioningProfile.TCProfileList_THolder tcProfileList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException;
