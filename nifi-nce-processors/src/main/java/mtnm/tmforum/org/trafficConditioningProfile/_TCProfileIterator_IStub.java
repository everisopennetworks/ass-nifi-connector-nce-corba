...
public class _TCProfileIterator_IStub
	...
	implements mtnm.tmforum.org.trafficConditioningProfile.TCProfileIterator_I
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = mtnm.tmforum.org.trafficConditioningProfile.TCProfileIterator_IOperations.class;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					tcProfileList.value = mtnm.tmforum.org.trafficConditioningProfile.TCProfileList_THelper.read(_is);
					return _result;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
