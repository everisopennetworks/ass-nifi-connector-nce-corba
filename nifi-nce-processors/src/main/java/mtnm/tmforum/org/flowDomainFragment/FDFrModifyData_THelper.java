...
public abstract class FDFrModifyData_THelper
{
	...
	public static void insert (final org.omg.CORBA.Any any, final mtnm.tmforum.org.flowDomainFragment.FDFrModifyData_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static mtnm.tmforum.org.flowDomainFragment.FDFrModifyData_T extract (final org.omg.CORBA.Any any)
	{
	...
	public static mtnm.tmforum.org.flowDomainFragment.FDFrModifyData_T read (final org.omg.CORBA.portable.InputStream in)
	{
		mtnm.tmforum.org.flowDomainFragment.FDFrModifyData_T result = new mtnm.tmforum.org.flowDomainFragment.FDFrModifyData_T();
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final mtnm.tmforum.org.flowDomainFragment.FDFrModifyData_T s)
	{
		java.lang.String tmpResult175 = s.userLabel;
out.write_string( tmpResult175 );
		out.write_boolean(s.forceUniqueness);
		java.lang.String tmpResult176 = s.owner;
out.write_string( tmpResult176 );
		java.lang.String tmpResult177 = s.networkAccessDomain;
