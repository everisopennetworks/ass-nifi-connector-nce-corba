...
public class _FDFrIterator_IStub
	...
	implements mtnm.tmforum.org.flowDomainFragment.FDFrIterator_I
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = mtnm.tmforum.org.flowDomainFragment.FDFrIterator_IOperations.class;
	...
	public boolean next_n(int how_many, mtnm.tmforum.org.flowDomainFragment.FDFrList_THolder fdfrList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
