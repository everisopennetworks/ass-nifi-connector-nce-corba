...
public abstract class FDFrList_THelper
{
	...
	public static void insert (org.omg.CORBA.Any any, mtnm.tmforum.org.flowDomainFragment.FlowDomainFragment_T[] s)
	{
		any.type (type ());
	...
	public static mtnm.tmforum.org.flowDomainFragment.FlowDomainFragment_T[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		mtnm.tmforum.org.flowDomainFragment.FlowDomainFragment_T[] _result;
		...
		_result = new mtnm.tmforum.org.flowDomainFragment.FlowDomainFragment_T[_l_result39];
		for (int i=0;i<_result.length;i++)
		{
			_result[i]=mtnm.tmforum.org.flowDomainFragment.FlowDomainFragment_THelper.read(_in);
		}

		return _result;
	}

	public static void write (final org.omg.CORBA.portable.OutputStream _out, mtnm.tmforum.org.flowDomainFragment.FlowDomainFragment_T[] _s)
	{
		
		_out.write_long(_s.length);
		for (int i=0; i<_s.length;i++)
		{
			mtnm.tmforum.org.flowDomainFragment.FlowDomainFragment_THelper.write(_out,_s[i]);
		}
