...
public interface ProtectionSubnetworkIterator_IOperations
{
	/* constants */
	/* operations  */
	boolean next_n(int how_many, mtnm.tmforum.org.protection.ProtectionSubnetworkList_THolder PGPList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException;
