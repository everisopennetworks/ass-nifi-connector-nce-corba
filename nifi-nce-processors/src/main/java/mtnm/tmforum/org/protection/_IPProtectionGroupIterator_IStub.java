...
public class _IPProtectionGroupIterator_IStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements mtnm.tmforum.org.protection.IPProtectionGroupIterator_I
{
	/** Serial version UID. */
	private static final long serialVersionUID = 1L;
	private String[] ids = {"IDL:mtnm.tmforum.org/protection/IPProtectionGroupIterator_I:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = mtnm.tmforum.org.protection.IPProtectionGroupIterator_IOperations.class;
	public int getLength() throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			IPProtectionGroupIterator_IOperations _localServant = (IPProtectionGroupIterator_IOperations)_so.servant;
			int _result;
			try
			{
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					pgpList.value = mtnm.tmforum.org.protection.IPProtectionGroupList_THelper.read(_is);
					return _result;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
