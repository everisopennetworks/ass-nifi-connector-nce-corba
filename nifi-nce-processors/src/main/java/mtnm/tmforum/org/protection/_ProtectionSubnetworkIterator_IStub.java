...
public class _ProtectionSubnetworkIterator_IStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements mtnm.tmforum.org.protection.ProtectionSubnetworkIterator_I
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = mtnm.tmforum.org.protection.ProtectionSubnetworkIterator_IOperations.class;
	public int getLength() throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			ProtectionSubnetworkIterator_IOperations _localServant = (ProtectionSubnetworkIterator_IOperations)_so.servant;
			int _result;
			try
			{
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					PGPList.value = mtnm.tmforum.org.protection.ProtectionSubnetworkList_THelper.read(_is);
					return _result;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
