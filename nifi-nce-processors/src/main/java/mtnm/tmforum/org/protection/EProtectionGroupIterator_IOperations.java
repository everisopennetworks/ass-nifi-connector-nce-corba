...
public interface EProtectionGroupIterator_IOperations
{
	/* constants */
	/* operations  */
	boolean next_n(int how_many, mtnm.tmforum.org.protection.EProtectionGroupList_THolder ePGPList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException;
