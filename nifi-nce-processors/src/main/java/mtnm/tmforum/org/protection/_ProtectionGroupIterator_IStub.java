...
public class _ProtectionGroupIterator_IStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements mtnm.tmforum.org.protection.ProtectionGroupIterator_I
{
	/** Serial version UID. */
	private static final long serialVersionUID = 1L;
	private String[] ids = {"IDL:mtnm.tmforum.org/protection/ProtectionGroupIterator_I:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = mtnm.tmforum.org.protection.ProtectionGroupIterator_IOperations.class;
	public boolean next_n(int how_many, mtnm.tmforum.org.protection.ProtectionGroupList_THolder pgpList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					pgpList.value = mtnm.tmforum.org.protection.ProtectionGroupList_THelper.read(_is);
					return _result;
				}
		...
		else
		{
			...
			if( _so == null )
				continue;
			ProtectionGroupIterator_IOperations _localServant = (ProtectionGroupIterator_IOperations)_so.servant;
			boolean _result;
			try
			{
