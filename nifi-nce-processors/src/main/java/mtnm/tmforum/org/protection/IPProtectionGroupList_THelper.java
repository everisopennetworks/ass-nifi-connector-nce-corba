...
public abstract class IPProtectionGroupList_THelper
{
	private volatile static org.omg.CORBA.TypeCode _type;

	public static void insert (org.omg.CORBA.Any any, mtnm.tmforum.org.protection.IPProtectionGroup_T[] s)
	{
		any.type (type ());
		write (any.create_output_stream (), s);
	}

	public static mtnm.tmforum.org.protection.IPProtectionGroup_T[] extract (final org.omg.CORBA.Any any)
	{
	...
	public static mtnm.tmforum.org.protection.IPProtectionGroup_T[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		mtnm.tmforum.org.protection.IPProtectionGroup_T[] _result;
		...
		_result = new mtnm.tmforum.org.protection.IPProtectionGroup_T[_l_result160];
		for (int i=0;i<_result.length;i++)
		{
			_result[i]=mtnm.tmforum.org.protection.IPProtectionGroup_THelper.read(_in);
		}

		return _result;
	}

	public static void write (final org.omg.CORBA.portable.OutputStream _out, mtnm.tmforum.org.protection.IPProtectionGroup_T[] _s)
	{
		
		_out.write_long(_s.length);
		for (int i=0; i<_s.length;i++)
		{
			mtnm.tmforum.org.protection.IPProtectionGroup_THelper.write(_out,_s[i]);
		}
