...
public class _HW_XPICGroupIterator_IStub
	...
	implements mtnm.tmforum.org.protection.HW_XPICGroupIterator_I
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = mtnm.tmforum.org.protection.HW_XPICGroupIterator_IOperations.class;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					xpicGroupList.value = mtnm.tmforum.org.protection.HW_XPICGroupList_THelper.read(_is);
					return _result;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
