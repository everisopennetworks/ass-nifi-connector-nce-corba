...
public abstract class ProtectionGroupIterator_IPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, mtnm.tmforum.org.protection.ProtectionGroupIterator_IOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				mtnm.tmforum.org.protection.ProtectionGroupList_THolder _arg1= new mtnm.tmforum.org.protection.ProtectionGroupList_THolder();
				_out = handler.createReply();
				_out.write_boolean(next_n(_arg0,_arg1));
				mtnm.tmforum.org.protection.ProtectionGroupList_THelper.write(_out,_arg1.value);
			}
