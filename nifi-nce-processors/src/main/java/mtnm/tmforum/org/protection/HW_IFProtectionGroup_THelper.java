...
public abstract class HW_IFProtectionGroup_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(HW_IFProtectionGroup_THelper.class)
			{
				if (_type == null)
				{
	...
	public static void insert (final org.omg.CORBA.Any any, final mtnm.tmforum.org.protection.HW_IFProtectionGroup_T s)
	{
		any.type(type());
	...
	public static mtnm.tmforum.org.protection.HW_IFProtectionGroup_T read (final org.omg.CORBA.portable.InputStream in)
	{
		mtnm.tmforum.org.protection.HW_IFProtectionGroup_T result = new mtnm.tmforum.org.protection.HW_IFProtectionGroup_T();
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final mtnm.tmforum.org.protection.HW_IFProtectionGroup_T s)
	{
		mtnm.tmforum.org.globaldefs.NVSList_THelper.write(out,s.name);
		java.lang.String tmpResult658 = s.userLabel;
out.write_string( tmpResult658 );
		java.lang.String tmpResult659 = s.nativeEMSName;
out.write_string( tmpResult659 );
		java.lang.String tmpResult660 = s.owner;
out.write_string( tmpResult660 );
