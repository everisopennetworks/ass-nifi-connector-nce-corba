...
public abstract class HW_ERPSProtectionGroup_THelper
{
	...
	public static void insert (final org.omg.CORBA.Any any, final mtnm.tmforum.org.protection.HW_ERPSProtectionGroup_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static mtnm.tmforum.org.protection.HW_ERPSProtectionGroup_T extract (final org.omg.CORBA.Any any)
	{
	...
	{
		return "IDL:mtnm.tmforum.org/protection/HW_ERPSProtectionGroup_T:1.0";
	}
	public static mtnm.tmforum.org.protection.HW_ERPSProtectionGroup_T read (final org.omg.CORBA.portable.InputStream in)
	{
		mtnm.tmforum.org.protection.HW_ERPSProtectionGroup_T result = new mtnm.tmforum.org.protection.HW_ERPSProtectionGroup_T();
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final mtnm.tmforum.org.protection.HW_ERPSProtectionGroup_T s)
	{
		mtnm.tmforum.org.globaldefs.NVSList_THelper.write(out,s.name);
		java.lang.String tmpResult655 = s.userLabel;
out.write_string( tmpResult655 );
		java.lang.String tmpResult656 = s.nativeEMSName;
out.write_string( tmpResult656 );
		java.lang.String tmpResult657 = s.owner;
out.write_string( tmpResult657 );
