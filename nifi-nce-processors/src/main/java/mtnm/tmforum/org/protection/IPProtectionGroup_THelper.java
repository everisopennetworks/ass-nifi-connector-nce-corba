...
public abstract class IPProtectionGroup_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(IPProtectionGroup_THelper.class)
			{
				if (_type == null)
				{
	...
	public static void insert (final org.omg.CORBA.Any any, final mtnm.tmforum.org.protection.IPProtectionGroup_T s)
	{
		any.type(type());
	...
	public static mtnm.tmforum.org.protection.IPProtectionGroup_T read (final org.omg.CORBA.portable.InputStream in)
	{
		mtnm.tmforum.org.protection.IPProtectionGroup_T result = new mtnm.tmforum.org.protection.IPProtectionGroup_T();
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final mtnm.tmforum.org.protection.IPProtectionGroup_T s)
	{
		mtnm.tmforum.org.globaldefs.NVSList_THelper.write(out,s.name);
		java.lang.String tmpResult638 = s.userLabel;
out.write_string( tmpResult638 );
		java.lang.String tmpResult639 = s.nativeEMSName;
out.write_string( tmpResult639 );
		java.lang.String tmpResult640 = s.owner;
out.write_string( tmpResult640 );
		java.lang.String tmpResult641 = s.protectionGroupType;
