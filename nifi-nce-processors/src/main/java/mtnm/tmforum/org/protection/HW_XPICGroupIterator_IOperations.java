...
public interface HW_XPICGroupIterator_IOperations
{
	/* constants */
	/* operations  */
	boolean next_n(int how_many, mtnm.tmforum.org.protection.HW_XPICGroupList_THolder xpicGroupList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException;
