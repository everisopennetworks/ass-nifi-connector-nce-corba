...
public abstract class PGPModifyData_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(PGPModifyData_THelper.class)
			{
				if (_type == null)
				{
	...
	public static void insert (final org.omg.CORBA.Any any, final mtnm.tmforum.org.protection.PGPModifyData_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static mtnm.tmforum.org.protection.PGPModifyData_T extract (final org.omg.CORBA.Any any)
	{
	...
	public static mtnm.tmforum.org.protection.PGPModifyData_T read (final org.omg.CORBA.portable.InputStream in)
	{
		mtnm.tmforum.org.protection.PGPModifyData_T result = new mtnm.tmforum.org.protection.PGPModifyData_T();
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final mtnm.tmforum.org.protection.PGPModifyData_T s)
	{
		java.lang.String tmpResult627 = s.userLabel;
out.write_string( tmpResult627 );
		out.write_boolean(s.forceUniqueness);
		java.lang.String tmpResult628 = s.owner;
out.write_string( tmpResult628 );
