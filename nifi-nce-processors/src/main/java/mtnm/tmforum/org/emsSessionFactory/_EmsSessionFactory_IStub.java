...
public class _EmsSessionFactory_IStub
	...
	implements mtnm.tmforum.org.emsSessionFactory.EmsSessionFactory_I
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = mtnm.tmforum.org.emsSessionFactory.EmsSessionFactory_IOperations.class;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult61 = user;
_os.write_string( tmpResult61 );
					java.lang.String tmpResult62 = password;
_os.write_string( tmpResult62 );
					mtnm.tmforum.org.nmsSession.NmsSession_IHelper.write(_os,client);
					_is = _invoke(_os);
					emsSessionInterface.value = mtnm.tmforum.org.emsSession.EmsSession_IHelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
