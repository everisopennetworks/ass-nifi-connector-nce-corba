...
public abstract class TopoMgr_IPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, mtnm.tmforum.org.TopoManagementManager.TopoMgr_IOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getAllClockSourceViewlTopologicalLinks", Integer.valueOf(3));
		m_opsHash.put ( "getTopoSubnetworkViewInfo", Integer.valueOf(4));
		m_opsHash.put ( "setAdditionalInfo", Integer.valueOf(5));
		m_opsHash.put ( "setOwner", Integer.valueOf(6));
		m_opsHash.put ( "getViewInfoByTopoSubnetwork", Integer.valueOf(7));
		m_opsHash.put ( "getProtectSubnetworkViewInfo", Integer.valueOf(8));
		m_opsHash.put ( "getClockSourceSubnetworkViewInfo", Integer.valueOf(9));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 3: // getAllClockSourceViewlTopologicalLinks
			{
			try
			{
			...
			case 4: // getTopoSubnetworkViewInfo
			{
			try
			{
				int _arg0=_input.read_ulong();
				mtnm.tmforum.org.TopoManagementManager.NodeList_THolder _arg1= new mtnm.tmforum.org.TopoManagementManager.NodeList_THolder();
				mtnm.tmforum.org.TopoManagementManager.NodeIterator_IHolder _arg2= new mtnm.tmforum.org.TopoManagementManager.NodeIterator_IHolder();
				_out = handler.createReply();
				getTopoSubnetworkViewInfo(_arg0,_arg1,_arg2);
				mtnm.tmforum.org.TopoManagementManager.NodeList_THelper.write(_out,_arg1.value);
				mtnm.tmforum.org.TopoManagementManager.NodeIterator_IHelper.write(_out,_arg2.value);
			}
			catch(mtnm.tmforum.org.globaldefs.ProcessingFailureException _ex0)
			{
				_out = handler.createExceptionReply();
			...
			case 7: // getViewInfoByTopoSubnetwork
			{
			try
			{
				mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] _arg0=mtnm.tmforum.org.globaldefs.NVSList_THelper.read(_input);
				int _arg1=_input.read_ulong();
				mtnm.tmforum.org.TopoManagementManager.NodeList_THolder _arg2= new mtnm.tmforum.org.TopoManagementManager.NodeList_THolder();
				mtnm.tmforum.org.TopoManagementManager.NodeIterator_IHolder _arg3= new mtnm.tmforum.org.TopoManagementManager.NodeIterator_IHolder();
				_out = handler.createReply();
				getViewInfoByTopoSubnetwork(_arg0,_arg1,_arg2,_arg3);
				mtnm.tmforum.org.TopoManagementManager.NodeList_THelper.write(_out,_arg2.value);
				mtnm.tmforum.org.TopoManagementManager.NodeIterator_IHelper.write(_out,_arg3.value);
			}
			catch(mtnm.tmforum.org.globaldefs.ProcessingFailureException _ex0)
			{
				_out = handler.createExceptionReply();
			...
			case 8: // getProtectSubnetworkViewInfo
			{
			try
			{
				int _arg0=_input.read_ulong();
			...
			case 9: // getClockSourceSubnetworkViewInfo
			{
			try
			{
				int _arg0=_input.read_ulong();
