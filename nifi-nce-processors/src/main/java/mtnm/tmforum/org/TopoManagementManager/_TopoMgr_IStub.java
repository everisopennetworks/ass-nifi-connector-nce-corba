...
public class _TopoMgr_IStub
	...
	implements mtnm.tmforum.org.TopoManagementManager.TopoMgr_I
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = mtnm.tmforum.org.TopoManagementManager.TopoMgr_IOperations.class;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult687 = userLabel;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,objectName);
					java.lang.String tmpResult688 = nativeEMSName;
	...
	public void getAllClockSourceViewlTopologicalLinks(int how_many, mtnm.tmforum.org.topologicalLink.TopologicalLinkList_THolder topoList, mtnm.tmforum.org.topologicalLink.TopologicalLinkIterator_IHolder topoIt) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getAllClockSourceViewlTopologicalLinks", true);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					NodeIt.value = mtnm.tmforum.org.TopoManagementManager.NodeIterator_IHelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,objectName);
					java.lang.String tmpResult689 = owner;
	...
	public void getViewInfoByTopoSubnetwork(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] topoSubnetwork, int how_many, mtnm.tmforum.org.TopoManagementManager.NodeList_THolder nodeList, mtnm.tmforum.org.TopoManagementManager.NodeIterator_IHolder NodeIt) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getViewInfoByTopoSubnetwork", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,topoSubnetwork);
					_os.write_ulong(how_many);
					_is = _invoke(_os);
					nodeList.value = mtnm.tmforum.org.TopoManagementManager.NodeList_THelper.read(_is);
					NodeIt.value = mtnm.tmforum.org.TopoManagementManager.NodeIterator_IHelper.read(_is);
	...
	public void getProtectSubnetworkViewInfo(int how_many, mtnm.tmforum.org.TopoManagementManager.NodeList_THolder nodeList, mtnm.tmforum.org.TopoManagementManager.NodeIterator_IHolder NodeIt) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getProtectSubnetworkViewInfo", true);
					_os.write_ulong(how_many);
					_is = _invoke(_os);
					nodeList.value = mtnm.tmforum.org.TopoManagementManager.NodeList_THelper.read(_is);
					NodeIt.value = mtnm.tmforum.org.TopoManagementManager.NodeIterator_IHelper.read(_is);
	...
	public void getClockSourceSubnetworkViewInfo(int how_many, mtnm.tmforum.org.TopoManagementManager.NodeList_THolder nodeList, mtnm.tmforum.org.TopoManagementManager.NodeIterator_IHolder NodeIt) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getClockSourceSubnetworkViewInfo", true);
					_os.write_ulong(how_many);
					_is = _invoke(_os);
					nodeList.value = mtnm.tmforum.org.TopoManagementManager.NodeList_THelper.read(_is);
					NodeIt.value = mtnm.tmforum.org.TopoManagementManager.NodeIterator_IHelper.read(_is);
