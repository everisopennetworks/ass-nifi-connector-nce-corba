...
public abstract class HW_VirtualBridgeIterator_IPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, mtnm.huawei.com.HW_mstpInventoryMgr.HW_VirtualBridgeIterator_IOperations
{
	...
	private String[] ids = {"IDL:mtnm.huawei.com/HW_mstpInventory/HW_VirtualBridgeIterator_I:1.0"};
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				mtnm.huawei.com.HW_mstpInventoryMgr.HW_VirtualBridgeList_THolder _arg1= new mtnm.huawei.com.HW_mstpInventoryMgr.HW_VirtualBridgeList_THolder();
				_out = handler.createReply();
				_out.write_boolean(next_n(_arg0,_arg1));
				mtnm.huawei.com.HW_mstpInventoryMgr.HW_VirtualBridgeList_THelper.write(_out,_arg1.value);
			}
			catch(mtnm.tmforum.org.globaldefs.ProcessingFailureException _ex0)
			{
				_out = handler.createExceptionReply();
