...
public class _HW_MSTPEndPointIterator_IStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements mtnm.huawei.com.HW_mstpInventoryMgr.HW_MSTPEndPointIterator_I
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = mtnm.huawei.com.HW_mstpInventoryMgr.HW_MSTPEndPointIterator_IOperations.class;
	public boolean next_n(int how_many, mtnm.huawei.com.HW_mstpInventoryMgr.HW_MSTPEndPointList_THolder endPointList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
		...
		else
		{
			...
			if( _so == null )
				continue;
			HW_MSTPEndPointIterator_IOperations _localServant = (HW_MSTPEndPointIterator_IOperations)_so.servant;
			boolean _result;
			try
			{
				_result = _localServant.next_n(how_many,endPointList);
