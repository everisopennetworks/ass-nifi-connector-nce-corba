...
public interface HW_VirtualBridgeIterator_IOperations
{
	/* constants */
	/* operations  */
	boolean next_n(int how_many, mtnm.huawei.com.HW_mstpInventoryMgr.HW_VirtualBridgeList_THolder vbList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException;
