...
public class _HW_VirtualBridgeIterator_IStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements mtnm.huawei.com.HW_mstpInventoryMgr.HW_VirtualBridgeIterator_I
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = mtnm.huawei.com.HW_mstpInventoryMgr.HW_VirtualBridgeIterator_IOperations.class;
	public int getLength() throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			HW_VirtualBridgeIterator_IOperations _localServant = (HW_VirtualBridgeIterator_IOperations)_so.servant;
			int _result;
			try
			{
	...
	public boolean next_n(int how_many, mtnm.huawei.com.HW_mstpInventoryMgr.HW_VirtualBridgeList_THolder vbList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		...
		else
		{
			...
			try
			{
				_result = _localServant.next_n(how_many,vbList);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
