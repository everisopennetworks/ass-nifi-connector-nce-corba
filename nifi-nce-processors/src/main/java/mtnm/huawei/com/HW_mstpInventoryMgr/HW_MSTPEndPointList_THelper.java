...
/**
 * Generated from IDL alias "HW_MSTPEndPointList_T".
 *
 * @author JacORB IDL compiler V 3.9
 * @version generated at 13/07/2021 04:51:40 PM
 */

public abstract class HW_MSTPEndPointList_THelper
{
	...
	public static mtnm.huawei.com.HW_mstpInventoryMgr.HW_MSTPEndPoint_T[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		{
			 int x = _in.available();
			 if ( x > 0 && _l_result62 > x )
				{
					throw new org.omg.CORBA.MARSHAL("Sequence length too large. Only " + x + " available and trying to assign " + _l_result62);
				}
		}
		catch (java.io.IOException e)
		{
		}
		_result = new mtnm.huawei.com.HW_mstpInventoryMgr.HW_MSTPEndPoint_T[_l_result62];
