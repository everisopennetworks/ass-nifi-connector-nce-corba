...
public class _HW_VirtualLANIterator_IStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements mtnm.huawei.com.HW_mstpInventoryMgr.HW_VirtualLANIterator_I
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = mtnm.huawei.com.HW_mstpInventoryMgr.HW_VirtualLANIterator_IOperations.class;
	public int getLength() throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			HW_VirtualLANIterator_IOperations _localServant = (HW_VirtualLANIterator_IOperations)_so.servant;
			int _result;
			try
			{
	...
	public boolean next_n(int how_many, mtnm.huawei.com.HW_mstpInventoryMgr.HW_VirtualLANList_THolder vlanList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		...
		else
		{
			...
			try
			{
				_result = _localServant.next_n(how_many,vlanList);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
