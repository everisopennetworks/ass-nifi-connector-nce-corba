...
public abstract class HW_VirtualBridge_THelper
{
	...
	public static void insert (final org.omg.CORBA.Any any, final mtnm.huawei.com.HW_mstpInventoryMgr.HW_VirtualBridge_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static mtnm.huawei.com.HW_mstpInventoryMgr.HW_VirtualBridge_T extract (final org.omg.CORBA.Any any)
	{
	...
	public static mtnm.huawei.com.HW_mstpInventoryMgr.HW_VirtualBridge_T read (final org.omg.CORBA.portable.InputStream in)
	{
		mtnm.huawei.com.HW_mstpInventoryMgr.HW_VirtualBridge_T result = new mtnm.huawei.com.HW_mstpInventoryMgr.HW_VirtualBridge_T();
		result.name = mtnm.tmforum.org.globaldefs.NVSList_THelper.read(in);
		result.userLabel=in.read_string();
		result.nativeEMSName=in.read_string();
		result.owner=in.read_string();
		result.logicalTPList = mtnm.huawei.com.HW_mstpInventoryMgr.HW_MSTPLogicalEndPointList_THelper.read(in);
		result.additionalInfo = mtnm.tmforum.org.globaldefs.NVSList_THelper.read(in);
		return result;
	}
	public static void write (final org.omg.CORBA.portable.OutputStream out, final mtnm.huawei.com.HW_mstpInventoryMgr.HW_VirtualBridge_T s)
	{
		mtnm.tmforum.org.globaldefs.NVSList_THelper.write(out,s.name);
		java.lang.String tmpResult312 = s.userLabel;
out.write_string( tmpResult312 );
		java.lang.String tmpResult313 = s.nativeEMSName;
out.write_string( tmpResult313 );
		java.lang.String tmpResult314 = s.owner;
out.write_string( tmpResult314 );
		mtnm.huawei.com.HW_mstpInventoryMgr.HW_MSTPLogicalEndPointList_THelper.write(out,s.logicalTPList);
