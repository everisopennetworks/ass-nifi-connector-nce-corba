...
public interface HW_QosRuleIterator_IOperations
{
	/* constants */
	/* operations  */
	boolean next_n(int how_many, mtnm.huawei.com.HW_mstpInventoryMgr.HW_QosRuleList_THolder qosRuleList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException;
