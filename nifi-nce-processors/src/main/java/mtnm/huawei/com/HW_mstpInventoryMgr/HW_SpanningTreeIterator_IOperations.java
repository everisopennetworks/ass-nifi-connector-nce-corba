...
public interface HW_SpanningTreeIterator_IOperations
{
	/* constants */
	/* operations  */
	boolean next_n(int how_many, mtnm.huawei.com.HW_mstpInventoryMgr.HW_SpanningTreeList_THolder SpanningTreeList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException;
