...
public abstract class HW_VirtualBridgeList_THelper
{
	private volatile static org.omg.CORBA.TypeCode _type;

	public static void insert (org.omg.CORBA.Any any, mtnm.huawei.com.HW_mstpInventoryMgr.HW_VirtualBridge_T[] s)
	{
		any.type (type ());
	...
	{
		return "IDL:mtnm.huawei.com/HW_mstpInventory/HW_VirtualBridgeList_T:1.0";
	}
	public static mtnm.huawei.com.HW_mstpInventoryMgr.HW_VirtualBridge_T[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		mtnm.huawei.com.HW_mstpInventoryMgr.HW_VirtualBridge_T[] _result;
		...
		_result = new mtnm.huawei.com.HW_mstpInventoryMgr.HW_VirtualBridge_T[_l_result65];
		for (int i=0;i<_result.length;i++)
		{
			_result[i]=mtnm.huawei.com.HW_mstpInventoryMgr.HW_VirtualBridge_THelper.read(_in);
		}

		return _result;
	}

	public static void write (final org.omg.CORBA.portable.OutputStream _out, mtnm.huawei.com.HW_mstpInventoryMgr.HW_VirtualBridge_T[] _s)
	{
		
		_out.write_long(_s.length);
		for (int i=0; i<_s.length;i++)
		{
			mtnm.huawei.com.HW_mstpInventoryMgr.HW_VirtualBridge_THelper.write(_out,_s[i]);
		}
