...
public class _HW_controlPlaneMgr_IStub
	...
	implements mtnm.huawei.com.HW_controlPlane.HW_controlPlaneMgr_I
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = mtnm.huawei.com.HW_controlPlane.HW_controlPlaneMgr_IOperations.class;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult304 = userLabel;
_os.write_string( tmpResult304 );
	...
	public void getAllSnppLinks(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] routingAreaName, int how_many, mtnm.huawei.com.HW_controlPlane.HW_SnppLinkList_THolder snppLinkList, mtnm.huawei.com.HW_controlPlane.HW_SnppLinkIterator_IHolder snppLinkIt) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getAllSnppLinks", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,routingAreaName);
					_os.write_ulong(how_many);
					_is = _invoke(_os);
					snppLinkList.value = mtnm.huawei.com.HW_controlPlane.HW_SnppLinkList_THelper.read(_is);
					snppLinkIt.value = mtnm.huawei.com.HW_controlPlane.HW_SnppLinkIterator_IHelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,objectName);
					java.lang.String tmpResult305 = nativeEMSName;
_os.write_string( tmpResult305 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
	...
	public void getAllRoutingAreaNames(mtnm.tmforum.org.globaldefs.NamingAttributesList_THolder nameList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getAllRoutingAreaNames", true);
					_is = _invoke(_os);
	...
	public void getMENameByNodeID(java.lang.String nodeID, mtnm.tmforum.org.globaldefs.NamingAttributesList_THolder meOrHolderNameList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getMENameByNodeID", true);
					java.lang.String tmpResult306 = nodeID;
_os.write_string( tmpResult306 );
					_is = _invoke(_os);
					meOrHolderNameList.value = mtnm.tmforum.org.globaldefs.NamingAttributesList_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,objectName);
					java.lang.String tmpResult307 = owner;
_os.write_string( tmpResult307 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
	...
	public void getAllRoutingNodeNames(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] routingAreaName, int how_many, mtnm.tmforum.org.globaldefs.NamingAttributesList_THolder nodeNameList, mtnm.tmforum.org.globaldefs.NamingAttributesIterator_IHolder nodeIt) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getAllRoutingNodeNames", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,routingAreaName);
					_os.write_ulong(how_many);
					_is = _invoke(_os);
					nodeNameList.value = mtnm.tmforum.org.globaldefs.NamingAttributesList_THelper.read(_is);
					nodeIt.value = mtnm.tmforum.org.globaldefs.NamingAttributesIterator_IHelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
	...
	public void getAllSnppNames(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] routingNodeName, int how_many, mtnm.tmforum.org.globaldefs.NamingAttributesList_THolder nameList, mtnm.tmforum.org.globaldefs.NamingAttributesIterator_IHolder nameIt) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getAllSnppNames", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,routingNodeName);
					_os.write_ulong(how_many);
					_is = _invoke(_os);
					nameList.value = mtnm.tmforum.org.globaldefs.NamingAttributesList_THelper.read(_is);
	...
	public void getAllContainedSnpNames(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] snppName, int how_many, mtnm.tmforum.org.globaldefs.NamingAttributesList_THolder nameList, mtnm.tmforum.org.globaldefs.NamingAttributesIterator_IHolder nameIt) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getAllContainedSnpNames", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,snppName);
					_os.write_ulong(how_many);
					_is = _invoke(_os);
					nameList.value = mtnm.tmforum.org.globaldefs.NamingAttributesList_THelper.read(_is);
					nameIt.value = mtnm.tmforum.org.globaldefs.NamingAttributesIterator_IHelper.read(_is);
	...
	public void getNodeIDByMEName(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] meOrHolderName, mtnm.huawei.com.HW_controlPlane.HW_controlPlaneMgr_IPackage.nodeIDList_THolder nodeID) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getNodeIDByMEName", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,meOrHolderName);
					_is = _invoke(_os);
					nodeID.value = mtnm.huawei.com.HW_controlPlane.HW_controlPlaneMgr_IPackage.nodeIDList_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
	...
	public void setSRLG(int srlgID, boolean addOrRemove, mtnm.tmforum.org.globaldefs.NamingAttributesList_THolder snppLinkNameList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "setSRLG", true);
					_os.write_ulong(srlgID);
					_os.write_boolean(addOrRemove);
					mtnm.tmforum.org.globaldefs.NamingAttributesList_THelper.write(_os,snppLinkNameList.value);
					_is = _invoke(_os);
					snppLinkNameList.value = mtnm.tmforum.org.globaldefs.NamingAttributesList_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
	...
	public void getSnppLink(mtnm.tmforum.org.globaldefs.NameAndStringValue_T[] snppLinkName, mtnm.huawei.com.HW_controlPlane.HW_SnppLink_THolder snppLink) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "getSnppLink", true);
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,snppLinkName);
					_is = _invoke(_os);
					snppLink.value = mtnm.huawei.com.HW_controlPlane.HW_SnppLink_THelper.read(_is);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
