...
public abstract class HW_SnppLinkList_THelper
{
	private volatile static org.omg.CORBA.TypeCode _type;

	public static void insert (org.omg.CORBA.Any any, mtnm.huawei.com.HW_controlPlane.HW_SnppLink_T[] s)
	{
		any.type (type ());
	...
	public static mtnm.huawei.com.HW_controlPlane.HW_SnppLink_T[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		mtnm.huawei.com.HW_controlPlane.HW_SnppLink_T[] _result;
		int _l_result57 = _in.read_long();
		try
		{
			 int x = _in.available();
			 if ( x > 0 && _l_result57 > x )
				{
					throw new org.omg.CORBA.MARSHAL("Sequence length too large. Only " + x + " available and trying to assign " + _l_result57);
				}
		}
		catch (java.io.IOException e)
		{
		}
		_result = new mtnm.huawei.com.HW_controlPlane.HW_SnppLink_T[_l_result57];
		for (int i=0;i<_result.length;i++)
		{
			_result[i]=mtnm.huawei.com.HW_controlPlane.HW_SnppLink_THelper.read(_in);
		}

		return _result;
	}

	public static void write (final org.omg.CORBA.portable.OutputStream _out, mtnm.huawei.com.HW_controlPlane.HW_SnppLink_T[] _s)
	{
		
		_out.write_long(_s.length);
		for (int i=0; i<_s.length;i++)
		{
			mtnm.huawei.com.HW_controlPlane.HW_SnppLink_THelper.write(_out,_s[i]);
		}
