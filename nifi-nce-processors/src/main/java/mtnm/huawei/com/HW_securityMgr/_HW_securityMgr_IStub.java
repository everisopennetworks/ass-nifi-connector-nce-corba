...
public class _HW_securityMgr_IStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements mtnm.huawei.com.HW_securityMgr.HW_securityMgr_I
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = mtnm.huawei.com.HW_securityMgr.HW_securityMgr_IOperations.class;
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					java.lang.String tmpResult355 = owner;
_os.write_string( tmpResult355 );
					_is = _invoke(_os);
					return;
				}
		...
		else
		{
			...
			if( _so == null )
				continue;
			HW_securityMgr_IOperations _localServant = (HW_securityMgr_IOperations)_so.servant;
			try
			{
	...
	public void modifyPassword(java.lang.String userName, java.lang.String oldPassword, java.lang.String newPassword) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "modifyPassword", true);
					java.lang.String tmpResult356 = userName;
_os.write_string( tmpResult356 );
					java.lang.String tmpResult357 = oldPassword;
_os.write_string( tmpResult357 );
					java.lang.String tmpResult358 = newPassword;
_os.write_string( tmpResult358 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "modifyPassword", _opsClass );
			if( _so == null )
				continue;
			HW_securityMgr_IOperations _localServant = (HW_securityMgr_IOperations)_so.servant;
			try
			{
				_localServant.modifyPassword(userName,oldPassword,newPassword);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,objectName);
					java.lang.String tmpResult359 = nativeEMSName;
_os.write_string( tmpResult359 );
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					mtnm.tmforum.org.globaldefs.NVSList_THelper.write(_os,objectName);
					java.lang.String tmpResult360 = userLabel;
_os.write_string( tmpResult360 );
