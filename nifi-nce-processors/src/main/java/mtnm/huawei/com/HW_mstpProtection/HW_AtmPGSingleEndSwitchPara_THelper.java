...
public abstract class HW_AtmPGSingleEndSwitchPara_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(HW_AtmPGSingleEndSwitchPara_THelper.class)
			{
				if (_type == null)
				{
	...
	public static void insert (final org.omg.CORBA.Any any, final mtnm.huawei.com.HW_mstpProtection.HW_AtmPGSingleEndSwitchPara_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static mtnm.huawei.com.HW_mstpProtection.HW_AtmPGSingleEndSwitchPara_T extract (final org.omg.CORBA.Any any)
	{
	...
	public static mtnm.huawei.com.HW_mstpProtection.HW_AtmPGSingleEndSwitchPara_T read (final org.omg.CORBA.portable.InputStream in)
	{
		mtnm.huawei.com.HW_mstpProtection.HW_AtmPGSingleEndSwitchPara_T result = new mtnm.huawei.com.HW_mstpProtection.HW_AtmPGSingleEndSwitchPara_T();
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final mtnm.huawei.com.HW_mstpProtection.HW_AtmPGSingleEndSwitchPara_T s)
	{
