...
public abstract class HW_AtmServiceProtectPairList_THelper
{
	private volatile static org.omg.CORBA.TypeCode _type;

	public static void insert (org.omg.CORBA.Any any, mtnm.huawei.com.HW_mstpProtection.HW_AtmServiceProtectPair_T[] s)
	{
		any.type (type ());
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(HW_AtmServiceProtectPairList_THelper.class)
			{
				if (_type == null)
				{
	...
	public static mtnm.huawei.com.HW_mstpProtection.HW_AtmServiceProtectPair_T[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		mtnm.huawei.com.HW_mstpProtection.HW_AtmServiceProtectPair_T[] _result;
		...
		_result = new mtnm.huawei.com.HW_mstpProtection.HW_AtmServiceProtectPair_T[_l_result75];
		for (int i=0;i<_result.length;i++)
		{
			_result[i]=mtnm.huawei.com.HW_mstpProtection.HW_AtmServiceProtectPair_THelper.read(_in);
		}

		return _result;
	}

	public static void write (final org.omg.CORBA.portable.OutputStream _out, mtnm.huawei.com.HW_mstpProtection.HW_AtmServiceProtectPair_T[] _s)
	{
		
		_out.write_long(_s.length);
		for (int i=0; i<_s.length;i++)
		{
			mtnm.huawei.com.HW_mstpProtection.HW_AtmServiceProtectPair_THelper.write(_out,_s[i]);
		}
