...
public abstract class SelfLearningMACAddressTableIterator_IPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, mtnm.huawei.com.HW_vpnManager.SelfLearningMACAddressTableIterator_IOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				mtnm.huawei.com.HW_vpnManager.SelfLearningMACAddressTableList_THolder _arg1= new mtnm.huawei.com.HW_vpnManager.SelfLearningMACAddressTableList_THolder();
				_out = handler.createReply();
				_out.write_boolean(next_n(_arg0,_arg1));
				mtnm.huawei.com.HW_vpnManager.SelfLearningMACAddressTableList_THelper.write(_out,_arg1.value);
			}
			catch(mtnm.tmforum.org.globaldefs.ProcessingFailureException _ex0)
			{
				_out = handler.createExceptionReply();
