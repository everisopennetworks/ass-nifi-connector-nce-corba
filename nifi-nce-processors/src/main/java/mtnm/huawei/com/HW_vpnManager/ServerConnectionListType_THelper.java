...
public abstract class ServerConnectionListType_THelper
{
	private volatile static org.omg.CORBA.TypeCode _type;

	public static void insert (org.omg.CORBA.Any any, mtnm.huawei.com.HW_vpnManager.ServerConnectionType_T[] s)
	{
		any.type (type ());
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(ServerConnectionListType_THelper.class)
			{
				if (_type == null)
				{
	...
	public static mtnm.huawei.com.HW_vpnManager.ServerConnectionType_T[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		mtnm.huawei.com.HW_vpnManager.ServerConnectionType_T[] _result;
		...
		_result = new mtnm.huawei.com.HW_vpnManager.ServerConnectionType_T[_l_result92];
		for (int i=0;i<_result.length;i++)
		{
			_result[i]=mtnm.huawei.com.HW_vpnManager.ServerConnectionType_THelper.read(_in);
		}

		return _result;
	}

	public static void write (final org.omg.CORBA.portable.OutputStream _out, mtnm.huawei.com.HW_vpnManager.ServerConnectionType_T[] _s)
	{
		
		_out.write_long(_s.length);
		for (int i=0; i<_s.length;i++)
		{
			mtnm.huawei.com.HW_vpnManager.ServerConnectionType_THelper.write(_out,_s[i]);
		}
