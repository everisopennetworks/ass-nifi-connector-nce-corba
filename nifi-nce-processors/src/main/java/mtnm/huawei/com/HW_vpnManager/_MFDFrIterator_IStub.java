...
public class _MFDFrIterator_IStub
	...
	implements mtnm.huawei.com.HW_vpnManager.MFDFrIterator_I
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = mtnm.huawei.com.HW_vpnManager.MFDFrIterator_IOperations.class;
	...
	public boolean next_n(int how_many, mtnm.huawei.com.HW_vpnManager.MatrixFlowDomainFragmentList_THolder mfdfrList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		while(true)
		{
			if(! this._is_local())
