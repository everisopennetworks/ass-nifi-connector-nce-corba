...
public interface TrafficTrunkIterator_IOperations
{
	/* constants */
	/* operations  */
	boolean next_n(int how_many, mtnm.huawei.com.HW_vpnManager.TrafficTrunkList_THolder trafficTrunkList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException;
