...
public interface MFDFrIterator_IOperations
{
	/* constants */
	/* operations  */
	boolean next_n(int how_many, mtnm.huawei.com.HW_vpnManager.MatrixFlowDomainFragmentList_THolder mfdfrList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException;
