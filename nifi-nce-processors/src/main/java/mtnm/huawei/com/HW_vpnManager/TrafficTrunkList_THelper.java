...
public abstract class TrafficTrunkList_THelper
{
	private volatile static org.omg.CORBA.TypeCode _type;

	public static void insert (org.omg.CORBA.Any any, mtnm.huawei.com.HW_vpnManager.TrafficTrunk_T[] s)
	{
		any.type (type ());
	...
	public static mtnm.huawei.com.HW_vpnManager.TrafficTrunk_T[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		mtnm.huawei.com.HW_vpnManager.TrafficTrunk_T[] _result;
		...
		_result = new mtnm.huawei.com.HW_vpnManager.TrafficTrunk_T[_l_result96];
		for (int i=0;i<_result.length;i++)
		{
			_result[i]=mtnm.huawei.com.HW_vpnManager.TrafficTrunk_THelper.read(_in);
		}

		return _result;
	}

	public static void write (final org.omg.CORBA.portable.OutputStream _out, mtnm.huawei.com.HW_vpnManager.TrafficTrunk_T[] _s)
	{
		
		_out.write_long(_s.length);
		for (int i=0; i<_s.length;i++)
		{
			mtnm.huawei.com.HW_vpnManager.TrafficTrunk_THelper.write(_out,_s[i]);
		}
