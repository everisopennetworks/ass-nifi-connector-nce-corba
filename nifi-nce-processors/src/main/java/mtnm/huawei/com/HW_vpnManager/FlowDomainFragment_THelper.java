...
public abstract class FlowDomainFragment_THelper
{
	...
	public static void insert (final org.omg.CORBA.Any any, final mtnm.huawei.com.HW_vpnManager.FlowDomainFragment_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static mtnm.huawei.com.HW_vpnManager.FlowDomainFragment_T extract (final org.omg.CORBA.Any any)
	{
	...
	public static mtnm.huawei.com.HW_vpnManager.FlowDomainFragment_T read (final org.omg.CORBA.portable.InputStream in)
	{
		mtnm.huawei.com.HW_vpnManager.FlowDomainFragment_T result = new mtnm.huawei.com.HW_vpnManager.FlowDomainFragment_T();
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final mtnm.huawei.com.HW_vpnManager.FlowDomainFragment_T s)
	{
		mtnm.tmforum.org.globaldefs.NVSList_THelper.write(out,s.name);
		java.lang.String tmpResult372 = s.userLabel;
out.write_string( tmpResult372 );
		java.lang.String tmpResult373 = s.nativeEMSName;
out.write_string( tmpResult373 );
		java.lang.String tmpResult374 = s.owner;
out.write_string( tmpResult374 );
		...
		java.lang.String tmpResult375 = s.networkAccessDomain;
out.write_string( tmpResult375 );
		...
		java.lang.String tmpResult376 = s.fdfrType;
out.write_string( tmpResult376 );
