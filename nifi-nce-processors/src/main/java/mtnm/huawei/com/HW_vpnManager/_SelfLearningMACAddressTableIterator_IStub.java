...
public class _SelfLearningMACAddressTableIterator_IStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements mtnm.huawei.com.HW_vpnManager.SelfLearningMACAddressTableIterator_I
{
	/** Serial version UID. */
	private static final long serialVersionUID = 1L;
	private String[] ids = {"IDL:mtnm.huawei.com/HW_vpnManager/SelfLearningMACAddressTableIterator_I:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = mtnm.huawei.com.HW_vpnManager.SelfLearningMACAddressTableIterator_IOperations.class;
	public int getLength() throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			SelfLearningMACAddressTableIterator_IOperations _localServant = (SelfLearningMACAddressTableIterator_IOperations)_so.servant;
			int _result;
			try
			{
	...
	public boolean next_n(int how_many, mtnm.huawei.com.HW_vpnManager.SelfLearningMACAddressTableList_THolder tableList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		...
		else
		{
			...
			try
			{
				_result = _localServant.next_n(how_many,tableList);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
