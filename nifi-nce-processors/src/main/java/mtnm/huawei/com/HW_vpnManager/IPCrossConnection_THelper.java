...
public abstract class IPCrossConnection_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			synchronized(IPCrossConnection_THelper.class)
			{
				if (_type == null)
				{
	...
	public static void insert (final org.omg.CORBA.Any any, final mtnm.huawei.com.HW_vpnManager.IPCrossConnection_T s)
	{
		any.type(type());
	...
	public static mtnm.huawei.com.HW_vpnManager.IPCrossConnection_T read (final org.omg.CORBA.portable.InputStream in)
	{
		mtnm.huawei.com.HW_vpnManager.IPCrossConnection_T result = new mtnm.huawei.com.HW_vpnManager.IPCrossConnection_T();
		...
		result.aEndList = mtnm.tmforum.org.subnetworkConnection.TPDataList_THelper.read(in);
		result.zEndList = mtnm.tmforum.org.subnetworkConnection.TPDataList_THelper.read(in);
		result.additionalInfo = mtnm.tmforum.org.globaldefs.NVSList_THelper.read(in);
		return result;
	}
	public static void write (final org.omg.CORBA.portable.OutputStream out, final mtnm.huawei.com.HW_vpnManager.IPCrossConnection_T s)
	{
		mtnm.tmforum.org.globaldefs.NVSList_THelper.write(out,s.name);
		java.lang.String tmpResult386 = s.nativeEMSName;
out.write_string( tmpResult386 );
		java.lang.String tmpResult387 = s.userLabel;
out.write_string( tmpResult387 );
		...
		mtnm.tmforum.org.subnetworkConnection.TPDataList_THelper.write(out,s.aEndList);
		mtnm.tmforum.org.subnetworkConnection.TPDataList_THelper.write(out,s.zEndList);
