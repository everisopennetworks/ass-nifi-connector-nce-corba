...
public interface HW_EthServiceIterator_IOperations
{
	/* constants */
	/* operations  */
	boolean next_n(int how_many, mtnm.huawei.com.HW_mstpService.HW_EthServiceList_THolder serviceList) throws mtnm.tmforum.org.globaldefs.ProcessingFailureException;
