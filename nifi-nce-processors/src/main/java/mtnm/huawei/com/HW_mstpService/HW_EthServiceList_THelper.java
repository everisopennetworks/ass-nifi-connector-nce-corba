...
public abstract class HW_EthServiceList_THelper
{
	private volatile static org.omg.CORBA.TypeCode _type;

	public static void insert (org.omg.CORBA.Any any, mtnm.huawei.com.HW_mstpService.HW_EthService_T[] s)
	{
		any.type (type ());
		write (any.create_output_stream (), s);
	}

	public static mtnm.huawei.com.HW_mstpService.HW_EthService_T[] extract (final org.omg.CORBA.Any any)
	{
	...
	public static mtnm.huawei.com.HW_mstpService.HW_EthService_T[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		mtnm.huawei.com.HW_mstpService.HW_EthService_T[] _result;
		...
		_result = new mtnm.huawei.com.HW_mstpService.HW_EthService_T[_l_result81];
		for (int i=0;i<_result.length;i++)
		{
			_result[i]=mtnm.huawei.com.HW_mstpService.HW_EthService_THelper.read(_in);
		}

		return _result;
	}

	public static void write (final org.omg.CORBA.portable.OutputStream _out, mtnm.huawei.com.HW_mstpService.HW_EthService_T[] _s)
	{
		
		_out.write_long(_s.length);
		for (int i=0; i<_s.length;i++)
		{
			mtnm.huawei.com.HW_mstpService.HW_EthService_THelper.write(_out,_s[i]);
		}
