...
public class _HW_EthServiceIterator_IStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements mtnm.huawei.com.HW_mstpService.HW_EthServiceIterator_I
{
	/** Serial version UID. */
	private static final long serialVersionUID = 1L;
	private String[] ids = {"IDL:mtnm.huawei.com/HW_mstpService/HW_EthServiceIterator_I:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = mtnm.huawei.com.HW_mstpService.HW_EthServiceIterator_IOperations.class;
	public int getLength() throws mtnm.tmforum.org.globaldefs.ProcessingFailureException
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			HW_EthServiceIterator_IOperations _localServant = (HW_EthServiceIterator_IOperations)_so.servant;
			int _result;
			try
			{
